...
class audioRender(object):
    ...
    def LoadTrackFromMixData(self, db, mixData):
        return _pdje_python.audioRender_LoadTrackFromMixData(self, db, mixData)
...
class EDIT_ARG_KEY_VALUE(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        _pdje_python.EDIT_ARG_KEY_VALUE_swiginit(self, _pdje_python.new_EDIT_ARG_KEY_VALUE(*args))
    first = property(_pdje_python.EDIT_ARG_KEY_VALUE_first_get, _pdje_python.EDIT_ARG_KEY_VALUE_first_set)
    second = property(_pdje_python.EDIT_ARG_KEY_VALUE_second_get, _pdje_python.EDIT_ARG_KEY_VALUE_second_set)
    def __len__(self):
        return 2
    def __repr__(self):
    ...
    def __setitem__(self, index, val):
        if not (index % 2):
            ...
            self.second = val
    __swig_destroy__ = _pdje_python.delete_EDIT_ARG_KEY_VALUE

# Register EDIT_ARG_KEY_VALUE in _pdje_python:
_pdje_python.EDIT_ARG_KEY_VALUE_swigregister(EDIT_ARG_KEY_VALUE)
...
class NoteVisitor(object):
    ...
    def __init__(self):
        if self.__class__ == NoteVisitor:
            _self = None
        else:
            _self = self
        _pdje_python.NoteVisitor_swiginit(self, _pdje_python.new_NoteVisitor(_self, ))
    def __disown__(self):
        self.this.disown()
        _pdje_python.disown_NoteVisitor(self)
...
class MixVisitor(object):
    ...
    def __init__(self):
        if self.__class__ == MixVisitor:
            _self = None
        else:
            _self = self
        _pdje_python.MixVisitor_swiginit(self, _pdje_python.new_MixVisitor(_self, ))
    def __disown__(self):
        self.this.disown()
        _pdje_python.disown_MixVisitor(self)
        return weakref.proxy(self)
...
class KVVisitor(object):
    ...
    def __init__(self):
        if self.__class__ == KVVisitor:
            _self = None
        else:
            _self = self
        _pdje_python.KVVisitor_swiginit(self, _pdje_python.new_KVVisitor(_self, ))
    def __disown__(self):
        self.this.disown()
        _pdje_python.disown_KVVisitor(self)
        return weakref.proxy(self)
...
class MusicVisitor(object):
    ...
    def __init__(self):
        if self.__class__ == MusicVisitor:
            _self = None
        else:
            _self = self
        _pdje_python.MusicVisitor_swiginit(self, _pdje_python.new_MusicVisitor(_self, ))
    def __disown__(self):
        self.this.disown()
        _pdje_python.disown_MusicVisitor(self)
        return weakref.proxy(self)
