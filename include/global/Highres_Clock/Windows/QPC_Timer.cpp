...
{
    return static_cast<double>(tick / qpc_freq) +
...
{
    return (static_cast<double>(tick / qpc_freq) * 1000.0) +
...
{
    return static_cast<uint64_t>(tick / qpc_freq) *
               static_cast<uint64_t>(1000000) +
           static_cast<uint64_t>(tick % qpc_freq) *
