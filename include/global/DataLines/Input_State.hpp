...
/// ----------------------------------------------------------------------------
/// PDJE Mouse Button Bitmask Definitions
/// Derived from Microsoft Windows Raw Input API (winuser.h)
/// These constants are redefined for compatibility and interoperability.
/// Original numeric values are part of the public API specification,
/// not protected source code. No Windows SDK code is included.
/// ----------------------------------------------------------------------------
