...
public:
    /**
     * @brief Prepares finalized data. All computations are completed, and the data is made ready for use.
     * 
     * @param Global global bpm object
     * @param Local local bpm object
     */
...
private:
    ...
    /**
     * @brief Internally uses TimeStretch() and ChangeBPM(). Implements the Facade pattern.
     * 
     * @param targetBpm 
     * @param originBpm 
