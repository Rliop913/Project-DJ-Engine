...
public class audioRender : global::System.IDisposable {
  ...
  public SWIGTYPE_p_std__optionalT_std__vectorT_float_t_t rendered_frames {
    ...
    get {
      global::System.IntPtr cPtr = pdje_POLYGLOTPINVOKE.audioRender_rendered_frames_get(swigCPtr);
      SWIGTYPE_p_std__optionalT_std__vectorT_float_t_t ret = (cPtr == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_std__optionalT_std__vectorT_float_t_t(cPtr, false);
      return ret;
    } 
  }

  public bool LoadTrack(litedb db, trackdata td) {
    bool ret = pdje_POLYGLOTPINVOKE.audioRender_LoadTrack(swigCPtr, litedb.getCPtr(db), trackdata.getCPtr(td));
    if (pdje_POLYGLOTPINVOKE.SWIGPendingException.Pending) throw pdje_POLYGLOTPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public bool LoadTrackFromMixData(litedb db, SWIGTYPE_p_BIN mixData) {
    bool ret = pdje_POLYGLOTPINVOKE.audioRender_LoadTrackFromMixData(swigCPtr, litedb.getCPtr(db), SWIGTYPE_p_BIN.getCPtr(mixData));
    if (pdje_POLYGLOTPINVOKE.SWIGPendingException.Pending) throw pdje_POLYGLOTPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
