...
.. _file_include_core_MainObjects_editorObject_redo.cpp:
...
Definition (``include/core/MainObjects/editorObject/redo.cpp``)
---------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_core_MainObjects_editorObject_redo.cpp.rst
