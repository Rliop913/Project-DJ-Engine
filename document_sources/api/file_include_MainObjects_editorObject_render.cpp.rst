...
.. _file_include_MainObjects_editorObject_render.cpp:
...
Definition (``include\MainObjects\editorObject\render.cpp``)
------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_MainObjects_editorObject_render.cpp.rst
