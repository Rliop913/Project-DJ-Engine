...
.. _file_include_MainObjects_editorObject_commonfunction.cpp:
...
Definition (``include\MainObjects\editorObject\commonfunction.cpp``)
--------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_MainObjects_editorObject_commonfunction.cpp.rst
