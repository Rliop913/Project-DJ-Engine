...
.. _file_include_judge_InputParser_InputParser.hpp:

File InputParser.hpp
====================

|exhale_lsh| :ref:`Parent directory <dir_include_judge_InputParser>` (``include/judge/InputParser``)
...
Definition (``include/judge/InputParser/InputParser.hpp``)
----------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_judge_InputParser_InputParser.hpp.rst
