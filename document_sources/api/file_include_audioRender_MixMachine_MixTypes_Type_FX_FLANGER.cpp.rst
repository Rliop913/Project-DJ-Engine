...
.. _file_include_audioRender_MixMachine_MixTypes_Type_FX_FLANGER.cpp:
...
Definition (``include/audioRender/MixMachine/MixTypes/Type_FX_FLANGER.cpp``)
----------------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_audioRender_MixMachine_MixTypes_Type_FX_FLANGER.cpp.rst
