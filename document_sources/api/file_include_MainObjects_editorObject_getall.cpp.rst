...
.. _file_include_MainObjects_editorObject_getall.cpp:
...
Definition (``include\MainObjects\editorObject\getall.cpp``)
------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_MainObjects_editorObject_getall.cpp.rst
