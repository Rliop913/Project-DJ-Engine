...
.. _file_include_core_MainObjects_audioPlayer_audioPlayer.cpp:
...
Definition (``include/core/MainObjects/audioPlayer/audioPlayer.cpp``)
---------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_core_MainObjects_audioPlayer_audioPlayer.cpp.rst
