...
.. _file_include_input_DefaultDevs_windows_DefaultDevs.hpp:
...
.. toctree::
   ...
   program_listing_file_include_input_DefaultDevs_windows_DefaultDevs.hpp.rst
...
- ``MetadataTXRX.hpp`` (:ref:`file_include_input_DefaultDevs_windows_TXRX_MetadataTXRX.hpp`)
...
- ``PDJE_RAII_WRAP.hpp`` (:ref:`file_include_global_PDJE_RAII_WRAP.hpp`)
