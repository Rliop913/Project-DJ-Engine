...
|exhale_lsh| :ref:`Return to documentation for file <file_include_input_IPC_memory_windows_named_event.cpp>` (``include/input/IPC/memory/windows/named_event.cpp``)
