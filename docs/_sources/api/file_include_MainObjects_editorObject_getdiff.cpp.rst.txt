...
.. _file_include_MainObjects_editorObject_getdiff.cpp:
...
Definition (``include\MainObjects\editorObject\getdiff.cpp``)
-------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_MainObjects_editorObject_getdiff.cpp.rst
