...
BB2_8:
	...
	shl.b32 	%r290, %r1, 3;
	mov.u32 	%r291, _ZZ24_occa_Stockhoptimized6_0E6FRBank;
	add.s32 	%r292, %r291, %r290;
	st.shared.f32 	[%r292], %f196;
	add.f32 	%f197, %f195, 0f00000000;
	mov.u32 	%r293, _ZZ24_occa_Stockhoptimized6_0E6FIBank;
	add.s32 	%r294, %r293, %r290;
	st.shared.f32 	[%r294], %f197;
	sub.f32 	%f198, %f1, %f193;
	st.shared.f32 	[%r292+4], %f198;
	sub.f32 	%f200, %f172, %f195;
	st.shared.f32 	[%r294+4], %f200;
	bar.sync 	0;
	shl.b32 	%r295, %r1, 2;
	add.s32 	%r7, %r291, %r295;
	ld.shared.f32 	%f19, [%r7];
	add.s32 	%r8, %r293, %r295;
	ld.shared.f32 	%f20, [%r8];
	ld.shared.f32 	%f21, [%r7+128];
	ld.shared.f32 	%f22, [%r8+128];
	shr.u32 	%r298, %r1, 31;
	add.s32 	%r299, %r1, %r298;
	and.b32  	%r300, %r299, 268435454;
	sub.s32 	%r301, %r1, %r300;
	shl.b32 	%r302, %r301, 4;
	cvt.rn.f32.s32	%f201, %r302;
	...
	cvt.rni.s32.f32	%r660, %f203;
	cvt.rn.f32.s32	%f204, %r660;
...
BB2_11:
	.pragma "nounroll";
	ld.const.u32 	%r308, [%rd113];
	// inline asm
	{
	mad.lo.cc.u32   %r306, %r308, %r11, %r646;
	madc.hi.u32     %r646, %r308, %r11,  0;
	}
	// inline asm
	st.local.u32 	[%rd114], %r306;
	add.s64 	%rd114, %rd114, 4;
	add.s64 	%rd113, %rd113, 4;
	add.s32 	%r645, %r645, 1;
	setp.ne.s32	%p9, %r645, 0;
	@%p9 bra 	BB2_11;

	bfe.u32 	%r311, %r10, 23, 8;
	add.s32 	%r312, %r311, -128;
	shr.u32 	%r313, %r312, 5;
	and.b32  	%r16, %r10, -2147483648;
	st.local.u32 	[%rd3], %r646;
	bfe.u32 	%r17, %r10, 23, 5;
	mov.u32 	%r314, 6;
	sub.s32 	%r315, %r314, %r313;
	mul.wide.s32 	%rd60, %r315, 4;
	add.s64 	%rd8, %rd2, %rd60;
	ld.local.u32 	%r648, [%rd8];
	ld.local.u32 	%r647, [%rd8+-4];
	setp.eq.s32	%p10, %r17, 0;
	@%p10 bra 	BB2_14;

	mov.u32 	%r316, 32;
	sub.s32 	%r317, %r316, %r17;
	shr.u32 	%r318, %r647, %r317;
	shl.b32 	%r319, %r648, %r17;
	add.s32 	%r648, %r318, %r319;
	ld.local.u32 	%r320, [%rd8+-8];
	shr.u32 	%r321, %r320, %r317;
	shl.b32 	%r322, %r647, %r17;
	add.s32 	%r647, %r321, %r322;

BB2_14:
	shr.u32 	%r323, %r647, 30;
	shl.b32 	%r324, %r648, 2;
	add.s32 	%r650, %r324, %r323;
	shl.b32 	%r25, %r647, 2;
	shr.u32 	%r325, %r650, 31;
	shr.u32 	%r326, %r648, 30;
	add.s32 	%r26, %r325, %r326;
	setp.eq.s32	%p11, %r325, 0;
	@%p11 bra 	BB2_15;

	not.b32 	%r327, %r650;
	neg.s32 	%r649, %r25;
	setp.eq.s32	%p12, %r25, 0;
	selp.u32	%r328, 1, 0, %p12;
	add.s32 	%r650, %r328, %r327;
	xor.b32  	%r651, %r16, -2147483648;
	bra.uni 	BB2_17;
...
BB2_26:
	.pragma "nounroll";
	ld.const.u32 	%r336, [%rd115];
	// inline asm
	{
	mad.lo.cc.u32   %r334, %r336, %r38, %r654;
	madc.hi.u32     %r654, %r336, %r38,  0;
	}
	// inline asm
	st.local.u32 	[%rd116], %r334;
	add.s64 	%rd116, %rd116, 4;
	add.s64 	%rd115, %rd115, 4;
	add.s32 	%r653, %r653, 1;
	setp.ne.s32	%p20, %r653, 0;
	@%p20 bra 	BB2_26;

	bfe.u32 	%r339, %r37, 23, 8;
	add.s32 	%r340, %r339, -128;
	shr.u32 	%r341, %r340, 5;
	and.b32  	%r43, %r37, -2147483648;
	st.local.u32 	[%rd3], %r654;
	bfe.u32 	%r44, %r37, 23, 5;
	mov.u32 	%r342, 6;
	sub.s32 	%r343, %r342, %r341;
	mul.wide.s32 	%rd65, %r343, 4;
	add.s64 	%rd13, %rd2, %rd65;
	ld.local.u32 	%r656, [%rd13];
	ld.local.u32 	%r655, [%rd13+-4];
	setp.eq.s32	%p21, %r44, 0;
	@%p21 bra 	BB2_29;

	mov.u32 	%r344, 32;
	sub.s32 	%r345, %r344, %r44;
	shr.u32 	%r346, %r655, %r345;
	shl.b32 	%r347, %r656, %r44;
	add.s32 	%r656, %r346, %r347;
	ld.local.u32 	%r348, [%rd13+-8];
	shr.u32 	%r349, %r348, %r345;
	shl.b32 	%r350, %r655, %r44;
	add.s32 	%r655, %r349, %r350;

BB2_29:
	shr.u32 	%r351, %r655, 30;
	shl.b32 	%r352, %r656, 2;
	add.s32 	%r658, %r352, %r351;
	shl.b32 	%r52, %r655, 2;
	shr.u32 	%r353, %r658, 31;
	shr.u32 	%r354, %r656, 30;
	add.s32 	%r53, %r353, %r354;
	setp.eq.s32	%p22, %r353, 0;
	@%p22 bra 	BB2_30;

	not.b32 	%r355, %r658;
	neg.s32 	%r657, %r52;
	setp.eq.s32	%p23, %r52, 0;
	selp.u32	%r356, 1, 0, %p23;
	add.s32 	%r658, %r356, %r355;
	xor.b32  	%r659, %r43, -2147483648;
	bra.uni 	BB2_32;
...
BB2_38:
	...
	shl.b32 	%r363, %r362, 2;
	mov.u32 	%r364, _ZZ24_occa_Stockhoptimized6_0E6SRBank;
	add.s32 	%r365, %r364, %r363;
	st.shared.f32 	[%r365], %f241;
	add.f32 	%f242, %f20, %f240;
	mov.u32 	%r366, _ZZ24_occa_Stockhoptimized6_0E6SIBank;
	add.s32 	%r367, %r366, %r363;
	st.shared.f32 	[%r367], %f242;
	sub.f32 	%f243, %f19, %f238;
	st.shared.f32 	[%r365+8], %f243;
	sub.f32 	%f244, %f20, %f240;
	st.shared.f32 	[%r367+8], %f244;
	bar.sync 	0;
	add.s32 	%r63, %r364, %r295;
	ld.shared.f32 	%f48, [%r63];
	add.s32 	%r64, %r366, %r295;
	ld.shared.f32 	%f49, [%r64];
	ld.shared.f32 	%f50, [%r63+128];
	ld.shared.f32 	%f51, [%r64+128];
	shr.s32 	%r371, %r1, 31;
	shr.u32 	%r372, %r371, 30;
	add.s32 	%r373, %r1, %r372;
	and.b32  	%r374, %r373, 536870908;
	sub.s32 	%r375, %r1, %r374;
	shl.b32 	%r376, %r375, 3;
	cvt.rn.f32.s32	%f245, %r376;
	...
	cvt.rni.s32.f32	%r676, %f247;
	cvt.rn.f32.s32	%f248, %r676;
...
BB2_41:
	.pragma "nounroll";
	ld.const.u32 	%r382, [%rd117];
	// inline asm
	{
	mad.lo.cc.u32   %r380, %r382, %r67, %r662;
	madc.hi.u32     %r662, %r382, %r67,  0;
	}
	// inline asm
	st.local.u32 	[%rd118], %r380;
	add.s64 	%rd118, %rd118, 4;
	add.s64 	%rd117, %rd117, 4;
	add.s32 	%r661, %r661, 1;
	setp.ne.s32	%p31, %r661, 0;
	@%p31 bra 	BB2_41;

	bfe.u32 	%r385, %r66, 23, 8;
	add.s32 	%r386, %r385, -128;
	shr.u32 	%r387, %r386, 5;
	and.b32  	%r72, %r66, -2147483648;
	st.local.u32 	[%rd3], %r662;
	bfe.u32 	%r73, %r66, 23, 5;
	mov.u32 	%r388, 6;
	sub.s32 	%r389, %r388, %r387;
	mul.wide.s32 	%rd70, %r389, 4;
	add.s64 	%rd18, %rd2, %rd70;
	ld.local.u32 	%r664, [%rd18];
	ld.local.u32 	%r663, [%rd18+-4];
	setp.eq.s32	%p32, %r73, 0;
	@%p32 bra 	BB2_44;

	mov.u32 	%r390, 32;
	sub.s32 	%r391, %r390, %r73;
	shr.u32 	%r392, %r663, %r391;
	shl.b32 	%r393, %r664, %r73;
	add.s32 	%r664, %r392, %r393;
	ld.local.u32 	%r394, [%rd18+-8];
	shr.u32 	%r395, %r394, %r391;
	shl.b32 	%r396, %r663, %r73;
	add.s32 	%r663, %r395, %r396;

BB2_44:
	shr.u32 	%r397, %r663, 30;
	shl.b32 	%r398, %r664, 2;
	add.s32 	%r666, %r398, %r397;
	shl.b32 	%r81, %r663, 2;
	shr.u32 	%r399, %r666, 31;
	shr.u32 	%r400, %r664, 30;
	add.s32 	%r82, %r399, %r400;
	setp.eq.s32	%p33, %r399, 0;
	@%p33 bra 	BB2_45;

	not.b32 	%r401, %r666;
	neg.s32 	%r665, %r81;
	setp.eq.s32	%p34, %r81, 0;
	selp.u32	%r402, 1, 0, %p34;
	add.s32 	%r666, %r402, %r401;
	xor.b32  	%r667, %r72, -2147483648;
	bra.uni 	BB2_47;
...
BB2_56:
	.pragma "nounroll";
	ld.const.u32 	%r410, [%rd119];
	// inline asm
	{
	mad.lo.cc.u32   %r408, %r410, %r94, %r670;
	madc.hi.u32     %r670, %r410, %r94,  0;
	}
	// inline asm
	st.local.u32 	[%rd120], %r408;
	add.s64 	%rd120, %rd120, 4;
	add.s64 	%rd119, %rd119, 4;
	add.s32 	%r669, %r669, 1;
	setp.ne.s32	%p42, %r669, 0;
	@%p42 bra 	BB2_56;

	bfe.u32 	%r413, %r93, 23, 8;
	add.s32 	%r414, %r413, -128;
	shr.u32 	%r415, %r414, 5;
	and.b32  	%r99, %r93, -2147483648;
	st.local.u32 	[%rd3], %r670;
	bfe.u32 	%r100, %r93, 23, 5;
	mov.u32 	%r416, 6;
	sub.s32 	%r417, %r416, %r415;
	mul.wide.s32 	%rd75, %r417, 4;
	add.s64 	%rd23, %rd2, %rd75;
	ld.local.u32 	%r672, [%rd23];
	ld.local.u32 	%r671, [%rd23+-4];
	setp.eq.s32	%p43, %r100, 0;
	@%p43 bra 	BB2_59;

	mov.u32 	%r418, 32;
	sub.s32 	%r419, %r418, %r100;
	shr.u32 	%r420, %r671, %r419;
	shl.b32 	%r421, %r672, %r100;
	add.s32 	%r672, %r420, %r421;
	ld.local.u32 	%r422, [%rd23+-8];
	shr.u32 	%r423, %r422, %r419;
	shl.b32 	%r424, %r671, %r100;
	add.s32 	%r671, %r423, %r424;

BB2_59:
	shr.u32 	%r425, %r671, 30;
	shl.b32 	%r426, %r672, 2;
	add.s32 	%r674, %r426, %r425;
	shl.b32 	%r108, %r671, 2;
	shr.u32 	%r427, %r674, 31;
	shr.u32 	%r428, %r672, 30;
	add.s32 	%r109, %r427, %r428;
	setp.eq.s32	%p44, %r427, 0;
	@%p44 bra 	BB2_60;

	not.b32 	%r429, %r674;
	neg.s32 	%r673, %r108;
	setp.eq.s32	%p45, %r108, 0;
	selp.u32	%r430, 1, 0, %p45;
	add.s32 	%r674, %r430, %r429;
	xor.b32  	%r675, %r99, -2147483648;
	bra.uni 	BB2_62;
...
BB2_68:
	...
	shl.b32 	%r437, %r436, 2;
	add.s32 	%r439, %r291, %r437;
	st.shared.f32 	[%r439], %f285;
	add.f32 	%f286, %f49, %f284;
	add.s32 	%r441, %r293, %r437;
	st.shared.f32 	[%r441], %f286;
	sub.f32 	%f287, %f48, %f282;
	st.shared.f32 	[%r439+16], %f287;
	sub.f32 	%f288, %f49, %f284;
	st.shared.f32 	[%r441+16], %f288;
	bar.sync 	0;
	ld.shared.f32 	%f77, [%r7];
	ld.shared.f32 	%f78, [%r8];
	ld.shared.f32 	%f79, [%r7+128];
	ld.shared.f32 	%f80, [%r8+128];
	shr.u32 	%r443, %r371, 29;
	add.s32 	%r444, %r1, %r443;
	and.b32  	%r445, %r444, 1073741816;
	sub.s32 	%r446, %r1, %r445;
	shl.b32 	%r447, %r446, 2;
	cvt.rn.f32.s32	%f289, %r447;
	...
	cvt.rni.s32.f32	%r692, %f291;
	cvt.rn.f32.s32	%f292, %r692;
...
BB2_71:
	.pragma "nounroll";
	ld.const.u32 	%r453, [%rd121];
	// inline asm
	{
	mad.lo.cc.u32   %r451, %r453, %r121, %r678;
	madc.hi.u32     %r678, %r453, %r121,  0;
	}
	// inline asm
	st.local.u32 	[%rd122], %r451;
	add.s64 	%rd122, %rd122, 4;
	add.s64 	%rd121, %rd121, 4;
	add.s32 	%r677, %r677, 1;
	setp.ne.s32	%p53, %r677, 0;
	@%p53 bra 	BB2_71;

	bfe.u32 	%r456, %r120, 23, 8;
	add.s32 	%r457, %r456, -128;
	shr.u32 	%r458, %r457, 5;
	and.b32  	%r126, %r120, -2147483648;
	st.local.u32 	[%rd3], %r678;
	bfe.u32 	%r127, %r120, 23, 5;
	mov.u32 	%r459, 6;
	sub.s32 	%r460, %r459, %r458;
	mul.wide.s32 	%rd80, %r460, 4;
	add.s64 	%rd28, %rd2, %rd80;
	ld.local.u32 	%r680, [%rd28];
	ld.local.u32 	%r679, [%rd28+-4];
	setp.eq.s32	%p54, %r127, 0;
	@%p54 bra 	BB2_74;

	mov.u32 	%r461, 32;
	sub.s32 	%r462, %r461, %r127;
	shr.u32 	%r463, %r679, %r462;
	shl.b32 	%r464, %r680, %r127;
	add.s32 	%r680, %r463, %r464;
	ld.local.u32 	%r465, [%rd28+-8];
	shr.u32 	%r466, %r465, %r462;
	shl.b32 	%r467, %r679, %r127;
	add.s32 	%r679, %r466, %r467;

BB2_74:
	shr.u32 	%r468, %r679, 30;
	shl.b32 	%r469, %r680, 2;
	add.s32 	%r682, %r469, %r468;
	shl.b32 	%r135, %r679, 2;
	shr.u32 	%r470, %r682, 31;
	shr.u32 	%r471, %r680, 30;
	add.s32 	%r136, %r470, %r471;
	setp.eq.s32	%p55, %r470, 0;
	@%p55 bra 	BB2_75;

	not.b32 	%r472, %r682;
	neg.s32 	%r681, %r135;
	setp.eq.s32	%p56, %r135, 0;
	selp.u32	%r473, 1, 0, %p56;
	add.s32 	%r682, %r473, %r472;
	xor.b32  	%r683, %r126, -2147483648;
	bra.uni 	BB2_77;
...
BB2_86:
	.pragma "nounroll";
	ld.const.u32 	%r481, [%rd123];
	// inline asm
	{
	mad.lo.cc.u32   %r479, %r481, %r148, %r686;
	madc.hi.u32     %r686, %r481, %r148,  0;
	}
	// inline asm
	st.local.u32 	[%rd124], %r479;
	add.s64 	%rd124, %rd124, 4;
	add.s64 	%rd123, %rd123, 4;
	add.s32 	%r685, %r685, 1;
	setp.ne.s32	%p64, %r685, 0;
	@%p64 bra 	BB2_86;

	bfe.u32 	%r484, %r147, 23, 8;
	add.s32 	%r485, %r484, -128;
	shr.u32 	%r486, %r485, 5;
	and.b32  	%r153, %r147, -2147483648;
	st.local.u32 	[%rd3], %r686;
	bfe.u32 	%r154, %r147, 23, 5;
	mov.u32 	%r487, 6;
	sub.s32 	%r488, %r487, %r486;
	mul.wide.s32 	%rd85, %r488, 4;
	add.s64 	%rd33, %rd2, %rd85;
	ld.local.u32 	%r688, [%rd33];
	ld.local.u32 	%r687, [%rd33+-4];
	setp.eq.s32	%p65, %r154, 0;
	@%p65 bra 	BB2_89;

	mov.u32 	%r489, 32;
	sub.s32 	%r490, %r489, %r154;
	shr.u32 	%r491, %r687, %r490;
	shl.b32 	%r492, %r688, %r154;
	add.s32 	%r688, %r491, %r492;
	ld.local.u32 	%r493, [%rd33+-8];
	shr.u32 	%r494, %r493, %r490;
	shl.b32 	%r495, %r687, %r154;
	add.s32 	%r687, %r494, %r495;

BB2_89:
	shr.u32 	%r496, %r687, 30;
	shl.b32 	%r497, %r688, 2;
	add.s32 	%r690, %r497, %r496;
	shl.b32 	%r162, %r687, 2;
	shr.u32 	%r498, %r690, 31;
	shr.u32 	%r499, %r688, 30;
	add.s32 	%r163, %r498, %r499;
	setp.eq.s32	%p66, %r498, 0;
	@%p66 bra 	BB2_90;

	not.b32 	%r500, %r690;
	neg.s32 	%r689, %r162;
	setp.eq.s32	%p67, %r162, 0;
	selp.u32	%r501, 1, 0, %p67;
	add.s32 	%r690, %r501, %r500;
	xor.b32  	%r691, %r153, -2147483648;
	bra.uni 	BB2_92;
...
BB2_98:
	...
	shl.b32 	%r508, %r507, 2;
	add.s32 	%r510, %r364, %r508;
	st.shared.f32 	[%r510], %f329;
	add.f32 	%f330, %f78, %f328;
	add.s32 	%r512, %r366, %r508;
	st.shared.f32 	[%r512], %f330;
	sub.f32 	%f331, %f77, %f326;
	st.shared.f32 	[%r510+32], %f331;
	sub.f32 	%f332, %f78, %f328;
	st.shared.f32 	[%r512+32], %f332;
	bar.sync 	0;
	ld.shared.f32 	%f106, [%r63];
	ld.shared.f32 	%f107, [%r64];
	ld.shared.f32 	%f108, [%r63+128];
	ld.shared.f32 	%f109, [%r64+128];
	shr.u32 	%r514, %r371, 28;
	add.s32 	%r515, %r1, %r514;
	and.b32  	%r516, %r515, 2147483632;
	sub.s32 	%r517, %r1, %r516;
	shl.b32 	%r518, %r517, 1;
	cvt.rn.f32.s32	%f333, %r518;
	...
	cvt.rni.s32.f32	%r708, %f335;
	cvt.rn.f32.s32	%f336, %r708;
...
BB2_101:
	.pragma "nounroll";
	ld.const.u32 	%r524, [%rd125];
	// inline asm
	{
	mad.lo.cc.u32   %r522, %r524, %r175, %r694;
	madc.hi.u32     %r694, %r524, %r175,  0;
	}
	// inline asm
	st.local.u32 	[%rd126], %r522;
	add.s64 	%rd126, %rd126, 4;
	add.s64 	%rd125, %rd125, 4;
	add.s32 	%r693, %r693, 1;
	setp.ne.s32	%p75, %r693, 0;
	@%p75 bra 	BB2_101;

	bfe.u32 	%r527, %r174, 23, 8;
	add.s32 	%r528, %r527, -128;
	shr.u32 	%r529, %r528, 5;
	and.b32  	%r180, %r174, -2147483648;
	st.local.u32 	[%rd3], %r694;
	bfe.u32 	%r181, %r174, 23, 5;
	mov.u32 	%r530, 6;
	sub.s32 	%r531, %r530, %r529;
	mul.wide.s32 	%rd90, %r531, 4;
	add.s64 	%rd38, %rd2, %rd90;
	ld.local.u32 	%r696, [%rd38];
	ld.local.u32 	%r695, [%rd38+-4];
	setp.eq.s32	%p76, %r181, 0;
	@%p76 bra 	BB2_104;

	mov.u32 	%r532, 32;
	sub.s32 	%r533, %r532, %r181;
	shr.u32 	%r534, %r695, %r533;
	shl.b32 	%r535, %r696, %r181;
	add.s32 	%r696, %r534, %r535;
	ld.local.u32 	%r536, [%rd38+-8];
	shr.u32 	%r537, %r536, %r533;
	shl.b32 	%r538, %r695, %r181;
	add.s32 	%r695, %r537, %r538;

BB2_104:
	shr.u32 	%r539, %r695, 30;
	shl.b32 	%r540, %r696, 2;
	add.s32 	%r698, %r540, %r539;
	shl.b32 	%r189, %r695, 2;
	shr.u32 	%r541, %r698, 31;
	shr.u32 	%r542, %r696, 30;
	add.s32 	%r190, %r541, %r542;
	setp.eq.s32	%p77, %r541, 0;
	@%p77 bra 	BB2_105;

	not.b32 	%r543, %r698;
	neg.s32 	%r697, %r189;
	setp.eq.s32	%p78, %r189, 0;
	selp.u32	%r544, 1, 0, %p78;
	add.s32 	%r698, %r544, %r543;
	xor.b32  	%r699, %r180, -2147483648;
	bra.uni 	BB2_107;
...
BB2_116:
	.pragma "nounroll";
	ld.const.u32 	%r552, [%rd127];
	// inline asm
	{
	mad.lo.cc.u32   %r550, %r552, %r202, %r702;
	madc.hi.u32     %r702, %r552, %r202,  0;
	}
	// inline asm
	st.local.u32 	[%rd128], %r550;
	add.s64 	%rd128, %rd128, 4;
	add.s64 	%rd127, %rd127, 4;
	add.s32 	%r701, %r701, 1;
	setp.ne.s32	%p86, %r701, 0;
	@%p86 bra 	BB2_116;

	bfe.u32 	%r555, %r201, 23, 8;
	add.s32 	%r556, %r555, -128;
	shr.u32 	%r557, %r556, 5;
	and.b32  	%r207, %r201, -2147483648;
	st.local.u32 	[%rd3], %r702;
	bfe.u32 	%r208, %r201, 23, 5;
	mov.u32 	%r558, 6;
	sub.s32 	%r559, %r558, %r557;
	mul.wide.s32 	%rd95, %r559, 4;
	add.s64 	%rd43, %rd2, %rd95;
	ld.local.u32 	%r704, [%rd43];
	ld.local.u32 	%r703, [%rd43+-4];
	setp.eq.s32	%p87, %r208, 0;
	@%p87 bra 	BB2_119;

	mov.u32 	%r560, 32;
	sub.s32 	%r561, %r560, %r208;
	shr.u32 	%r562, %r703, %r561;
	shl.b32 	%r563, %r704, %r208;
	add.s32 	%r704, %r562, %r563;
	ld.local.u32 	%r564, [%rd43+-8];
	shr.u32 	%r565, %r564, %r561;
	shl.b32 	%r566, %r703, %r208;
	add.s32 	%r703, %r565, %r566;

BB2_119:
	shr.u32 	%r567, %r703, 30;
	shl.b32 	%r568, %r704, 2;
	add.s32 	%r706, %r568, %r567;
	shl.b32 	%r216, %r703, 2;
	shr.u32 	%r569, %r706, 31;
	shr.u32 	%r570, %r704, 30;
	add.s32 	%r217, %r569, %r570;
	setp.eq.s32	%p88, %r569, 0;
	@%p88 bra 	BB2_120;

	not.b32 	%r571, %r706;
	neg.s32 	%r705, %r216;
	setp.eq.s32	%p89, %r216, 0;
	selp.u32	%r572, 1, 0, %p89;
	add.s32 	%r706, %r572, %r571;
	xor.b32  	%r707, %r207, -2147483648;
	bra.uni 	BB2_122;
...
BB2_128:
	...
	shl.b32 	%r579, %r578, 2;
	add.s32 	%r581, %r291, %r579;
	st.shared.f32 	[%r581], %f373;
	add.f32 	%f374, %f107, %f372;
	add.s32 	%r583, %r293, %r579;
	st.shared.f32 	[%r583], %f374;
	sub.f32 	%f375, %f106, %f370;
	st.shared.f32 	[%r581+64], %f375;
	sub.f32 	%f376, %f107, %f372;
	st.shared.f32 	[%r583+64], %f376;
	bar.sync 	0;
	ld.shared.f32 	%f135, [%r7];
	ld.shared.f32 	%f136, [%r8];
	ld.shared.f32 	%f137, [%r7+128];
	ld.shared.f32 	%f138, [%r8+128];
	add.s32 	%r227, %r2, %r1;
	shr.u32 	%r585, %r371, 27;
	add.s32 	%r586, %r1, %r585;
	and.b32  	%r587, %r586, -32;
	sub.s32 	%r588, %r1, %r587;
	cvt.rn.f32.s32	%f377, %r588;
	...
	cvt.rni.s32.f32	%r724, %f379;
	cvt.rn.f32.s32	%f380, %r724;
...
BB2_131:
	.pragma "nounroll";
	ld.const.u32 	%r594, [%rd129];
	// inline asm
	{
	mad.lo.cc.u32   %r592, %r594, %r230, %r710;
	madc.hi.u32     %r710, %r594, %r230,  0;
	}
	// inline asm
	st.local.u32 	[%rd130], %r592;
	add.s64 	%rd130, %rd130, 4;
	add.s64 	%rd129, %rd129, 4;
	add.s32 	%r709, %r709, 1;
	setp.ne.s32	%p97, %r709, 0;
	@%p97 bra 	BB2_131;

	bfe.u32 	%r597, %r229, 23, 8;
	add.s32 	%r598, %r597, -128;
	shr.u32 	%r599, %r598, 5;
	and.b32  	%r235, %r229, -2147483648;
	st.local.u32 	[%rd3], %r710;
	bfe.u32 	%r236, %r229, 23, 5;
	mov.u32 	%r600, 6;
	sub.s32 	%r601, %r600, %r599;
	mul.wide.s32 	%rd100, %r601, 4;
	add.s64 	%rd48, %rd2, %rd100;
	ld.local.u32 	%r712, [%rd48];
	ld.local.u32 	%r711, [%rd48+-4];
	setp.eq.s32	%p98, %r236, 0;
	@%p98 bra 	BB2_134;

	mov.u32 	%r602, 32;
	sub.s32 	%r603, %r602, %r236;
	shr.u32 	%r604, %r711, %r603;
	shl.b32 	%r605, %r712, %r236;
	add.s32 	%r712, %r604, %r605;
	ld.local.u32 	%r606, [%rd48+-8];
	shr.u32 	%r607, %r606, %r603;
	shl.b32 	%r608, %r711, %r236;
	add.s32 	%r711, %r607, %r608;

BB2_134:
	shr.u32 	%r609, %r711, 30;
	shl.b32 	%r610, %r712, 2;
	add.s32 	%r714, %r610, %r609;
	shl.b32 	%r244, %r711, 2;
	shr.u32 	%r611, %r714, 31;
	shr.u32 	%r612, %r712, 30;
	add.s32 	%r245, %r611, %r612;
	setp.eq.s32	%p99, %r611, 0;
	@%p99 bra 	BB2_135;

	not.b32 	%r613, %r714;
	neg.s32 	%r713, %r244;
	setp.eq.s32	%p100, %r244, 0;
	selp.u32	%r614, 1, 0, %p100;
	add.s32 	%r714, %r614, %r613;
	xor.b32  	%r715, %r235, -2147483648;
	bra.uni 	BB2_137;
...
BB2_137:
	...
	setp.eq.s32	%p102, %r235, 0;
	neg.s32 	%r615, %r245;
	selp.b32	%r716, %r245, %r615, %p102;

BB2_139:
	add.s32 	%r254, %r716, 1;
	and.b32  	%r255, %r254, 1;
	setp.eq.s32	%p103, %r255, 0;
...
BB2_146:
	.pragma "nounroll";
	ld.const.u32 	%r622, [%rd131];
	// inline asm
	{
	mad.lo.cc.u32   %r620, %r622, %r257, %r718;
	madc.hi.u32     %r718, %r622, %r257,  0;
	}
	// inline asm
	st.local.u32 	[%rd132], %r620;
	add.s64 	%rd132, %rd132, 4;
	add.s64 	%rd131, %rd131, 4;
	add.s32 	%r717, %r717, 1;
	setp.ne.s32	%p108, %r717, 0;
	@%p108 bra 	BB2_146;

	bfe.u32 	%r625, %r256, 23, 8;
	add.s32 	%r626, %r625, -128;
	shr.u32 	%r627, %r626, 5;
	and.b32  	%r262, %r256, -2147483648;
	st.local.u32 	[%rd3], %r718;
	bfe.u32 	%r263, %r256, 23, 5;
	mov.u32 	%r628, 6;
	sub.s32 	%r629, %r628, %r627;
	mul.wide.s32 	%rd105, %r629, 4;
	add.s64 	%rd53, %rd2, %rd105;
	ld.local.u32 	%r720, [%rd53];
	ld.local.u32 	%r719, [%rd53+-4];
	setp.eq.s32	%p109, %r263, 0;
	@%p109 bra 	BB2_149;

	mov.u32 	%r630, 32;
	sub.s32 	%r631, %r630, %r263;
	shr.u32 	%r632, %r719, %r631;
	shl.b32 	%r633, %r720, %r263;
	add.s32 	%r720, %r632, %r633;
	ld.local.u32 	%r634, [%rd53+-8];
	shr.u32 	%r635, %r634, %r631;
	shl.b32 	%r636, %r719, %r263;
	add.s32 	%r719, %r635, %r636;

BB2_149:
	shr.u32 	%r637, %r719, 30;
	shl.b32 	%r638, %r720, 2;
	add.s32 	%r722, %r638, %r637;
	shl.b32 	%r271, %r719, 2;
	shr.u32 	%r639, %r722, 31;
	shr.u32 	%r640, %r720, 30;
	add.s32 	%r272, %r639, %r640;
	setp.eq.s32	%p110, %r639, 0;
	@%p110 bra 	BB2_150;

	not.b32 	%r641, %r722;
	neg.s32 	%r721, %r271;
	setp.eq.s32	%p111, %r271, 0;
	selp.u32	%r642, 1, 0, %p111;
	add.s32 	%r722, %r642, %r641;
	xor.b32  	%r723, %r262, -2147483648;
	bra.uni 	BB2_152;
...
BB2_158:
	...
	mul.wide.u32 	%rd109, %r227, 4;
	add.s64 	%rd110, %rd1, %rd109;
	st.global.f32 	[%rd110], %f417;
	add.f32 	%f418, %f136, %f416;
	cvta.to.global.u64 	%rd111, %rd54;
	add.s64 	%rd112, %rd111, %rd109;
	st.global.f32 	[%rd112], %f418;
	sub.f32 	%f419, %f135, %f414;
	st.global.f32 	[%rd110+128], %f419;
	sub.f32 	%f420, %f136, %f416;
	st.global.f32 	[%rd112+128], %f420;
	ret;
}
...
.maxntid 64, 1, 1
{
	...
	ld.param.u64 	%rd63, [_occa_Stockhoptimized7_0_param_0];
	ld.param.u64 	%rd64, [_occa_Stockhoptimized7_0_param_1];
	mov.u32 	%r336, %ctaid.x;
	shl.b32 	%r337, %r336, 6;
	mov.u32 	%r1, %tid.x;
	add.s32 	%r338, %r337, %r1;
	and.b32  	%r339, %r338, 63;
	shl.b32 	%r340, %r338, 1;
	and.b32  	%r2, %r340, -128;
	add.s32 	%r341, %r2, %r339;
	cvta.to.global.u64 	%rd65, %rd63;
	mul.wide.u32 	%rd66, %r341, 4;
	add.s64 	%rd67, %rd65, %rd66;
	ld.global.f32 	%f1, [%rd67];
	ld.global.f32 	%f2, [%rd67+256];
	mov.f32 	%f194, 0f80000000;
	cvt.rni.s32.f32	%r3, %f194;
	cvt.rn.f32.s32	%f195, %r3;
...
BB3_8:
	...
	shl.b32 	%r344, %r1, 3;
	mov.u32 	%r345, _ZZ24_occa_Stockhoptimized7_0E6FRBank;
	add.s32 	%r346, %r345, %r344;
	st.shared.f32 	[%r346], %f225;
	add.f32 	%f226, %f224, 0f00000000;
	mov.u32 	%r347, _ZZ24_occa_Stockhoptimized7_0E6FIBank;
	add.s32 	%r348, %r347, %r344;
	st.shared.f32 	[%r348], %f226;
	sub.f32 	%f227, %f1, %f222;
	st.shared.f32 	[%r346+4], %f227;
	sub.f32 	%f229, %f201, %f224;
	st.shared.f32 	[%r348+4], %f229;
	bar.sync 	0;
	shl.b32 	%r349, %r1, 2;
	add.s32 	%r351, %r345, %r349;
	ld.shared.f32 	%f19, [%r351];
	add.s32 	%r353, %r347, %r349;
	ld.shared.f32 	%f20, [%r353];
	ld.shared.f32 	%f21, [%r351+256];
	ld.shared.f32 	%f22, [%r353+256];
	shr.u32 	%r354, %r1, 31;
	add.s32 	%r355, %r1, %r354;
	and.b32  	%r356, %r355, 134217726;
	sub.s32 	%r357, %r1, %r356;
	shl.b32 	%r358, %r357, 5;
	cvt.rn.f32.s32	%f230, %r358;
	mul.f32 	%f231, %f230, 0f3C000000;
	cvt.f64.f32	%fd1, %f231;
	mul.f64 	%fd2, %fd1, 0dC01921FB54442D18;
	cvt.rn.f32.f64	%f23, %fd2;
	mul.f32 	%f232, %f23, 0f3F22F983;
	cvt.rni.s32.f32	%r810, %f232;
	cvt.rn.f32.s32	%f233, %r810;
...
BB3_11:
	.pragma "nounroll";
	ld.const.u32 	%r364, [%rd134];
	// inline asm
	{
	mad.lo.cc.u32   %r362, %r364, %r9, %r796;
	madc.hi.u32     %r796, %r364, %r9,  0;
	}
	// inline asm
	st.local.u32 	[%rd135], %r362;
	add.s64 	%rd135, %rd135, 4;
	add.s64 	%rd134, %rd134, 4;
	add.s32 	%r795, %r795, 1;
	setp.ne.s32	%p9, %r795, 0;
	@%p9 bra 	BB3_11;

	bfe.u32 	%r367, %r8, 23, 8;
	add.s32 	%r368, %r367, -128;
	shr.u32 	%r369, %r368, 5;
	and.b32  	%r14, %r8, -2147483648;
	st.local.u32 	[%rd2], %r796;
	bfe.u32 	%r15, %r8, 23, 5;
	mov.u32 	%r370, 6;
	sub.s32 	%r371, %r370, %r369;
	mul.wide.s32 	%rd70, %r371, 4;
	add.s64 	%rd7, %rd1, %rd70;
	ld.local.u32 	%r798, [%rd7];
	ld.local.u32 	%r797, [%rd7+-4];
	setp.eq.s32	%p10, %r15, 0;
	@%p10 bra 	BB3_14;

	mov.u32 	%r372, 32;
	sub.s32 	%r373, %r372, %r15;
	shr.u32 	%r374, %r797, %r373;
	shl.b32 	%r375, %r798, %r15;
	add.s32 	%r798, %r374, %r375;
	ld.local.u32 	%r376, [%rd7+-8];
	shr.u32 	%r377, %r376, %r373;
	shl.b32 	%r378, %r797, %r15;
	add.s32 	%r797, %r377, %r378;

BB3_14:
	shr.u32 	%r379, %r797, 30;
	shl.b32 	%r380, %r798, 2;
	add.s32 	%r800, %r380, %r379;
	shl.b32 	%r23, %r797, 2;
	shr.u32 	%r381, %r800, 31;
	shr.u32 	%r382, %r798, 30;
	add.s32 	%r24, %r381, %r382;
	setp.eq.s32	%p11, %r381, 0;
	@%p11 bra 	BB3_15;

	not.b32 	%r383, %r800;
	neg.s32 	%r799, %r23;
	setp.eq.s32	%p12, %r23, 0;
	selp.u32	%r384, 1, 0, %p12;
	add.s32 	%r800, %r384, %r383;
	xor.b32  	%r801, %r14, -2147483648;
	bra.uni 	BB3_17;
...
BB3_26:
	.pragma "nounroll";
	ld.const.u32 	%r392, [%rd136];
	// inline asm
	{
	mad.lo.cc.u32   %r390, %r392, %r36, %r804;
	madc.hi.u32     %r804, %r392, %r36,  0;
	}
	// inline asm
	st.local.u32 	[%rd137], %r390;
	add.s64 	%rd137, %rd137, 4;
	add.s64 	%rd136, %rd136, 4;
	add.s32 	%r803, %r803, 1;
	setp.ne.s32	%p20, %r803, 0;
	@%p20 bra 	BB3_26;

	bfe.u32 	%r395, %r35, 23, 8;
	add.s32 	%r396, %r395, -128;
	shr.u32 	%r397, %r396, 5;
	and.b32  	%r41, %r35, -2147483648;
	st.local.u32 	[%rd2], %r804;
	bfe.u32 	%r42, %r35, 23, 5;
	mov.u32 	%r398, 6;
	sub.s32 	%r399, %r398, %r397;
	mul.wide.s32 	%rd75, %r399, 4;
	add.s64 	%rd12, %rd1, %rd75;
	ld.local.u32 	%r806, [%rd12];
	ld.local.u32 	%r805, [%rd12+-4];
	setp.eq.s32	%p21, %r42, 0;
	@%p21 bra 	BB3_29;

	mov.u32 	%r400, 32;
	sub.s32 	%r401, %r400, %r42;
	shr.u32 	%r402, %r805, %r401;
	shl.b32 	%r403, %r806, %r42;
	add.s32 	%r806, %r402, %r403;
	ld.local.u32 	%r404, [%rd12+-8];
	shr.u32 	%r405, %r404, %r401;
	shl.b32 	%r406, %r805, %r42;
	add.s32 	%r805, %r405, %r406;

BB3_29:
	shr.u32 	%r407, %r805, 30;
	shl.b32 	%r408, %r806, 2;
	add.s32 	%r808, %r408, %r407;
	shl.b32 	%r50, %r805, 2;
	shr.u32 	%r409, %r808, 31;
	shr.u32 	%r410, %r806, 30;
	add.s32 	%r51, %r409, %r410;
	setp.eq.s32	%p22, %r409, 0;
	@%p22 bra 	BB3_30;
	...
	add.s32 	%r808, %r412, %r411;
	xor.b32  	%r809, %r41, -2147483648;
	bra.uni 	BB3_32;
...
BB3_38:
	...
	shl.b32 	%r419, %r418, 2;
	mov.u32 	%r420, _ZZ24_occa_Stockhoptimized7_0E6SRBank;
	add.s32 	%r421, %r420, %r419;
	st.shared.f32 	[%r421], %f270;
	add.f32 	%f271, %f20, %f269;
	mov.u32 	%r422, _ZZ24_occa_Stockhoptimized7_0E6SIBank;
	add.s32 	%r423, %r422, %r419;
	st.shared.f32 	[%r423], %f271;
	sub.f32 	%f272, %f19, %f267;
	st.shared.f32 	[%r421+8], %f272;
	sub.f32 	%f273, %f20, %f269;
	st.shared.f32 	[%r423+8], %f273;
	bar.sync 	0;
	add.s32 	%r426, %r420, %r349;
	ld.shared.f32 	%f48, [%r426];
	add.s32 	%r428, %r422, %r349;
	ld.shared.f32 	%f49, [%r428];
	ld.shared.f32 	%f50, [%r426+256];
	ld.shared.f32 	%f51, [%r428+256];
	shr.s32 	%r429, %r1, 31;
	shr.u32 	%r430, %r429, 30;
	add.s32 	%r431, %r1, %r430;
	and.b32  	%r432, %r431, 268435452;
	sub.s32 	%r433, %r1, %r432;
	shl.b32 	%r434, %r433, 4;
	cvt.rn.f32.s32	%f274, %r434;
	mul.f32 	%f275, %f274, 0f3C000000;
	cvt.f64.f32	%fd7, %f275;
	mul.f64 	%fd8, %fd7, 0dC01921FB54442D18;
	cvt.rn.f32.f64	%f52, %fd8;
	mul.f32 	%f276, %f52, 0f3F22F983;
	cvt.rni.s32.f32	%r826, %f276;
	cvt.rn.f32.s32	%f277, %r826;
...
BB3_41:
	.pragma "nounroll";
	ld.const.u32 	%r440, [%rd138];
	// inline asm
	{
	mad.lo.cc.u32   %r438, %r440, %r64, %r812;
	madc.hi.u32     %r812, %r440, %r64,  0;
	}
	// inline asm
	st.local.u32 	[%rd139], %r438;
	add.s64 	%rd139, %rd139, 4;
	add.s64 	%rd138, %rd138, 4;
	add.s32 	%r811, %r811, 1;
	setp.ne.s32	%p31, %r811, 0;
	@%p31 bra 	BB3_41;

	bfe.u32 	%r443, %r63, 23, 8;
	add.s32 	%r444, %r443, -128;
	shr.u32 	%r445, %r444, 5;
	and.b32  	%r69, %r63, -2147483648;
	st.local.u32 	[%rd2], %r812;
	bfe.u32 	%r70, %r63, 23, 5;
	mov.u32 	%r446, 6;
	sub.s32 	%r447, %r446, %r445;
	mul.wide.s32 	%rd80, %r447, 4;
	add.s64 	%rd17, %rd1, %rd80;
	ld.local.u32 	%r814, [%rd17];
	ld.local.u32 	%r813, [%rd17+-4];
	setp.eq.s32	%p32, %r70, 0;
	@%p32 bra 	BB3_44;

	mov.u32 	%r448, 32;
	sub.s32 	%r449, %r448, %r70;
	shr.u32 	%r450, %r813, %r449;
	shl.b32 	%r451, %r814, %r70;
	add.s32 	%r814, %r450, %r451;
	ld.local.u32 	%r452, [%rd17+-8];
	shr.u32 	%r453, %r452, %r449;
	shl.b32 	%r454, %r813, %r70;
	add.s32 	%r813, %r453, %r454;

BB3_44:
	shr.u32 	%r455, %r813, 30;
	shl.b32 	%r456, %r814, 2;
	add.s32 	%r816, %r456, %r455;
	shl.b32 	%r78, %r813, 2;
	shr.u32 	%r457, %r816, 31;
	shr.u32 	%r458, %r814, 30;
	add.s32 	%r79, %r457, %r458;
	setp.eq.s32	%p33, %r457, 0;
	@%p33 bra 	BB3_45;

	not.b32 	%r459, %r816;
	neg.s32 	%r815, %r78;
	setp.eq.s32	%p34, %r78, 0;
	selp.u32	%r460, 1, 0, %p34;
	add.s32 	%r816, %r460, %r459;
	xor.b32  	%r817, %r69, -2147483648;
	bra.uni 	BB3_47;
...
BB3_47:
	cvt.u64.u32	%rd81, %r816;
	cvt.u64.u32	%rd82, %r815;
	bfi.b64 	%rd83, %rd81, %rd82, 32, 32;
	cvt.rn.f64.s64	%fd9, %rd83;
	mul.f64 	%fd10, %fd9, 0d3BF921FB54442D19;
	cvt.rn.f32.f64	%f283, %fd10;
	neg.f32 	%f284, %f283;
	setp.eq.s32	%p35, %r817, 0;
	selp.f32	%f504, %f283, %f284, %p35;
	setp.eq.s32	%p36, %r69, 0;
	neg.s32 	%r461, %r79;
	selp.b32	%r818, %r79, %r461, %p36;
...
BB3_56:
	.pragma "nounroll";
	ld.const.u32 	%r468, [%rd140];
	// inline asm
	{
	mad.lo.cc.u32   %r466, %r468, %r91, %r820;
	madc.hi.u32     %r820, %r468, %r91,  0;
	}
	// inline asm
	st.local.u32 	[%rd141], %r466;
	add.s64 	%rd141, %rd141, 4;
	add.s64 	%rd140, %rd140, 4;
	add.s32 	%r819, %r819, 1;
	setp.ne.s32	%p42, %r819, 0;
	@%p42 bra 	BB3_56;

	bfe.u32 	%r471, %r90, 23, 8;
	add.s32 	%r472, %r471, -128;
	shr.u32 	%r473, %r472, 5;
	and.b32  	%r96, %r90, -2147483648;
	st.local.u32 	[%rd2], %r820;
	bfe.u32 	%r97, %r90, 23, 5;
	mov.u32 	%r474, 6;
	sub.s32 	%r475, %r474, %r473;
	mul.wide.s32 	%rd85, %r475, 4;
	add.s64 	%rd22, %rd1, %rd85;
	ld.local.u32 	%r822, [%rd22];
	ld.local.u32 	%r821, [%rd22+-4];
	setp.eq.s32	%p43, %r97, 0;
	@%p43 bra 	BB3_59;

	mov.u32 	%r476, 32;
	sub.s32 	%r477, %r476, %r97;
	shr.u32 	%r478, %r821, %r477;
	shl.b32 	%r479, %r822, %r97;
	add.s32 	%r822, %r478, %r479;
	ld.local.u32 	%r480, [%rd22+-8];
	shr.u32 	%r481, %r480, %r477;
	shl.b32 	%r482, %r821, %r97;
	add.s32 	%r821, %r481, %r482;

BB3_59:
	shr.u32 	%r483, %r821, 30;
	shl.b32 	%r484, %r822, 2;
	add.s32 	%r824, %r484, %r483;
	shl.b32 	%r105, %r821, 2;
	shr.u32 	%r485, %r824, 31;
	shr.u32 	%r486, %r822, 30;
	add.s32 	%r106, %r485, %r486;
	setp.eq.s32	%p44, %r485, 0;
	@%p44 bra 	BB3_60;

	not.b32 	%r487, %r824;
	neg.s32 	%r823, %r105;
	setp.eq.s32	%p45, %r105, 0;
	selp.u32	%r488, 1, 0, %p45;
	add.s32 	%r824, %r488, %r487;
	xor.b32  	%r825, %r96, -2147483648;
	bra.uni 	BB3_62;
...
BB3_62:
	cvt.u64.u32	%rd86, %r824;
	cvt.u64.u32	%rd87, %r823;
	bfi.b64 	%rd88, %rd86, %rd87, 32, 32;
	cvt.rn.f64.s64	%fd11, %rd88;
	mul.f64 	%fd12, %fd11, 0d3BF921FB54442D19;
	cvt.rn.f32.f64	%f296, %fd12;
	neg.f32 	%f297, %f296;
	setp.eq.s32	%p46, %r825, 0;
	selp.f32	%f507, %f296, %f297, %p46;
	setp.eq.s32	%p47, %r96, 0;
	neg.s32 	%r489, %r106;
	selp.b32	%r826, %r106, %r489, %p47;
...
BB3_68:
	...
	shl.b32 	%r495, %r494, 2;
	add.s32 	%r497, %r345, %r495;
	st.shared.f32 	[%r497], %f314;
	add.f32 	%f315, %f49, %f313;
	add.s32 	%r499, %r347, %r495;
	st.shared.f32 	[%r499], %f315;
	sub.f32 	%f316, %f48, %f311;
	st.shared.f32 	[%r497+16], %f316;
	sub.f32 	%f317, %f49, %f313;
	st.shared.f32 	[%r499+16], %f317;
	bar.sync 	0;
	ld.shared.f32 	%f77, [%r351];
	ld.shared.f32 	%f78, [%r353];
	ld.shared.f32 	%f79, [%r351+256];
	ld.shared.f32 	%f80, [%r353+256];
	shr.u32 	%r506, %r429, 29;
	add.s32 	%r507, %r1, %r506;
	and.b32  	%r508, %r507, 536870904;
	sub.s32 	%r509, %r1, %r508;
	shl.b32 	%r510, %r509, 3;
	cvt.rn.f32.s32	%f318, %r510;
	mul.f32 	%f319, %f318, 0f3C000000;
	cvt.f64.f32	%fd13, %f319;
	mul.f64 	%fd14, %fd13, 0dC01921FB54442D18;
	cvt.rn.f32.f64	%f81, %fd14;
	mul.f32 	%f320, %f81, 0f3F22F983;
	cvt.rni.s32.f32	%r842, %f320;
	cvt.rn.f32.s32	%f321, %r842;
...
BB3_71:
	.pragma "nounroll";
	ld.const.u32 	%r516, [%rd142];
	// inline asm
	{
	mad.lo.cc.u32   %r514, %r516, %r119, %r828;
	madc.hi.u32     %r828, %r516, %r119,  0;
	}
	// inline asm
	st.local.u32 	[%rd143], %r514;
	add.s64 	%rd143, %rd143, 4;
	add.s64 	%rd142, %rd142, 4;
	add.s32 	%r827, %r827, 1;
	setp.ne.s32	%p53, %r827, 0;
	@%p53 bra 	BB3_71;

	bfe.u32 	%r519, %r118, 23, 8;
	add.s32 	%r520, %r519, -128;
	shr.u32 	%r521, %r520, 5;
	and.b32  	%r124, %r118, -2147483648;
	st.local.u32 	[%rd2], %r828;
	bfe.u32 	%r125, %r118, 23, 5;
	mov.u32 	%r522, 6;
	sub.s32 	%r523, %r522, %r521;
	mul.wide.s32 	%rd90, %r523, 4;
	add.s64 	%rd27, %rd1, %rd90;
	ld.local.u32 	%r830, [%rd27];
	ld.local.u32 	%r829, [%rd27+-4];
	setp.eq.s32	%p54, %r125, 0;
	@%p54 bra 	BB3_74;

	mov.u32 	%r524, 32;
	sub.s32 	%r525, %r524, %r125;
	shr.u32 	%r526, %r829, %r525;
	shl.b32 	%r527, %r830, %r125;
	add.s32 	%r830, %r526, %r527;
	ld.local.u32 	%r528, [%rd27+-8];
	shr.u32 	%r529, %r528, %r525;
	shl.b32 	%r530, %r829, %r125;
	add.s32 	%r829, %r529, %r530;

BB3_74:
	shr.u32 	%r531, %r829, 30;
	shl.b32 	%r532, %r830, 2;
	add.s32 	%r832, %r532, %r531;
	shl.b32 	%r133, %r829, 2;
	shr.u32 	%r533, %r832, 31;
	shr.u32 	%r534, %r830, 30;
	add.s32 	%r134, %r533, %r534;
	setp.eq.s32	%p55, %r533, 0;
	@%p55 bra 	BB3_75;

	not.b32 	%r535, %r832;
	neg.s32 	%r831, %r133;
	setp.eq.s32	%p56, %r133, 0;
	selp.u32	%r536, 1, 0, %p56;
	add.s32 	%r832, %r536, %r535;
	xor.b32  	%r833, %r124, -2147483648;
	bra.uni 	BB3_77;
...
BB3_77:
	cvt.u64.u32	%rd91, %r832;
	cvt.u64.u32	%rd92, %r831;
	bfi.b64 	%rd93, %rd91, %rd92, 32, 32;
	cvt.rn.f64.s64	%fd15, %rd93;
	mul.f64 	%fd16, %fd15, 0d3BF921FB54442D19;
	cvt.rn.f32.f64	%f327, %fd16;
	neg.f32 	%f328, %f327;
	setp.eq.s32	%p57, %r833, 0;
	selp.f32	%f510, %f327, %f328, %p57;
	setp.eq.s32	%p58, %r124, 0;
	neg.s32 	%r537, %r134;
	selp.b32	%r834, %r134, %r537, %p58;
...
BB3_86:
	.pragma "nounroll";
	ld.const.u32 	%r544, [%rd144];
	// inline asm
	{
	mad.lo.cc.u32   %r542, %r544, %r146, %r836;
	madc.hi.u32     %r836, %r544, %r146,  0;
	}
	// inline asm
	st.local.u32 	[%rd145], %r542;
	add.s64 	%rd145, %rd145, 4;
	add.s64 	%rd144, %rd144, 4;
	add.s32 	%r835, %r835, 1;
	setp.ne.s32	%p64, %r835, 0;
	@%p64 bra 	BB3_86;

	bfe.u32 	%r547, %r145, 23, 8;
	add.s32 	%r548, %r547, -128;
	shr.u32 	%r549, %r548, 5;
	and.b32  	%r151, %r145, -2147483648;
	st.local.u32 	[%rd2], %r836;
	bfe.u32 	%r152, %r145, 23, 5;
	mov.u32 	%r550, 6;
	sub.s32 	%r551, %r550, %r549;
	mul.wide.s32 	%rd95, %r551, 4;
	add.s64 	%rd32, %rd1, %rd95;
	ld.local.u32 	%r838, [%rd32];
	ld.local.u32 	%r837, [%rd32+-4];
	setp.eq.s32	%p65, %r152, 0;
	@%p65 bra 	BB3_89;

	mov.u32 	%r552, 32;
	sub.s32 	%r553, %r552, %r152;
	shr.u32 	%r554, %r837, %r553;
	shl.b32 	%r555, %r838, %r152;
	add.s32 	%r838, %r554, %r555;
	ld.local.u32 	%r556, [%rd32+-8];
	shr.u32 	%r557, %r556, %r553;
	shl.b32 	%r558, %r837, %r152;
	add.s32 	%r837, %r557, %r558;

BB3_89:
	shr.u32 	%r559, %r837, 30;
	shl.b32 	%r560, %r838, 2;
	add.s32 	%r840, %r560, %r559;
	shl.b32 	%r160, %r837, 2;
	shr.u32 	%r561, %r840, 31;
	shr.u32 	%r562, %r838, 30;
	add.s32 	%r161, %r561, %r562;
	setp.eq.s32	%p66, %r561, 0;
	@%p66 bra 	BB3_90;

	not.b32 	%r563, %r840;
	neg.s32 	%r839, %r160;
	setp.eq.s32	%p67, %r160, 0;
	selp.u32	%r564, 1, 0, %p67;
	add.s32 	%r840, %r564, %r563;
	xor.b32  	%r841, %r151, -2147483648;
	bra.uni 	BB3_92;
...
BB3_92:
	cvt.u64.u32	%rd96, %r840;
	cvt.u64.u32	%rd97, %r839;
	bfi.b64 	%rd98, %rd96, %rd97, 32, 32;
	cvt.rn.f64.s64	%fd17, %rd98;
	mul.f64 	%fd18, %fd17, 0d3BF921FB54442D19;
	cvt.rn.f32.f64	%f340, %fd18;
	neg.f32 	%f341, %f340;
	setp.eq.s32	%p68, %r841, 0;
	selp.f32	%f513, %f340, %f341, %p68;
	setp.eq.s32	%p69, %r151, 0;
	neg.s32 	%r565, %r161;
	selp.b32	%r842, %r161, %r565, %p69;
...
BB3_98:
	and.b32  	%r567, %r1, 7;
	and.b32  	%r569, %r415, 1073741808;
	add.s32 	%r570, %r569, %r567;
	...
	shl.b32 	%r571, %r570, 2;
	add.s32 	%r573, %r420, %r571;
	st.shared.f32 	[%r573], %f358;
	add.f32 	%f359, %f78, %f357;
	add.s32 	%r575, %r422, %r571;
	st.shared.f32 	[%r575], %f359;
	sub.f32 	%f360, %f77, %f355;
	st.shared.f32 	[%r573+32], %f360;
	sub.f32 	%f361, %f78, %f357;
	st.shared.f32 	[%r575+32], %f361;
	bar.sync 	0;
	ld.shared.f32 	%f106, [%r426];
	ld.shared.f32 	%f107, [%r428];
	ld.shared.f32 	%f108, [%r426+256];
	ld.shared.f32 	%f109, [%r428+256];
	shr.u32 	%r582, %r429, 28;
	add.s32 	%r583, %r1, %r582;
	and.b32  	%r584, %r583, 1073741808;
	sub.s32 	%r585, %r1, %r584;
	shl.b32 	%r586, %r585, 2;
	cvt.rn.f32.s32	%f362, %r586;
	mul.f32 	%f363, %f362, 0f3C000000;
	cvt.f64.f32	%fd19, %f363;
	mul.f64 	%fd20, %fd19, 0dC01921FB54442D18;
	cvt.rn.f32.f64	%f110, %fd20;
	mul.f32 	%f364, %f110, 0f3F22F983;
	cvt.rni.s32.f32	%r858, %f364;
	cvt.rn.f32.s32	%f365, %r858;
...
BB3_101:
	.pragma "nounroll";
	ld.const.u32 	%r592, [%rd146];
	// inline asm
	{
	mad.lo.cc.u32   %r590, %r592, %r174, %r844;
	madc.hi.u32     %r844, %r592, %r174,  0;
	}
	// inline asm
	st.local.u32 	[%rd147], %r590;
	add.s64 	%rd147, %rd147, 4;
	add.s64 	%rd146, %rd146, 4;
	add.s32 	%r843, %r843, 1;
	setp.ne.s32	%p75, %r843, 0;
	@%p75 bra 	BB3_101;

	bfe.u32 	%r595, %r173, 23, 8;
	add.s32 	%r596, %r595, -128;
	shr.u32 	%r597, %r596, 5;
	and.b32  	%r179, %r173, -2147483648;
	st.local.u32 	[%rd2], %r844;
	bfe.u32 	%r180, %r173, 23, 5;
	mov.u32 	%r598, 6;
	sub.s32 	%r599, %r598, %r597;
	mul.wide.s32 	%rd100, %r599, 4;
	add.s64 	%rd37, %rd1, %rd100;
	ld.local.u32 	%r846, [%rd37];
	ld.local.u32 	%r845, [%rd37+-4];
	setp.eq.s32	%p76, %r180, 0;
	@%p76 bra 	BB3_104;

	mov.u32 	%r600, 32;
	sub.s32 	%r601, %r600, %r180;
	shr.u32 	%r602, %r845, %r601;
	shl.b32 	%r603, %r846, %r180;
	add.s32 	%r846, %r602, %r603;
	ld.local.u32 	%r604, [%rd37+-8];
	shr.u32 	%r605, %r604, %r601;
	shl.b32 	%r606, %r845, %r180;
	add.s32 	%r845, %r605, %r606;

BB3_104:
	shr.u32 	%r607, %r845, 30;
	shl.b32 	%r608, %r846, 2;
	add.s32 	%r848, %r608, %r607;
	shl.b32 	%r188, %r845, 2;
	shr.u32 	%r609, %r848, 31;
	shr.u32 	%r610, %r846, 30;
	add.s32 	%r189, %r609, %r610;
	setp.eq.s32	%p77, %r609, 0;
	@%p77 bra 	BB3_105;

	not.b32 	%r611, %r848;
	neg.s32 	%r847, %r188;
	setp.eq.s32	%p78, %r188, 0;
	selp.u32	%r612, 1, 0, %p78;
	add.s32 	%r848, %r612, %r611;
	xor.b32  	%r849, %r179, -2147483648;
	bra.uni 	BB3_107;
...
BB3_107:
	cvt.u64.u32	%rd101, %r848;
	cvt.u64.u32	%rd102, %r847;
	bfi.b64 	%rd103, %rd101, %rd102, 32, 32;
	cvt.rn.f64.s64	%fd21, %rd103;
	mul.f64 	%fd22, %fd21, 0d3BF921FB54442D19;
	cvt.rn.f32.f64	%f371, %fd22;
	neg.f32 	%f372, %f371;
	setp.eq.s32	%p79, %r849, 0;
	selp.f32	%f516, %f371, %f372, %p79;
	setp.eq.s32	%p80, %r179, 0;
	neg.s32 	%r613, %r189;
	selp.b32	%r850, %r189, %r613, %p80;
...
BB3_116:
	.pragma "nounroll";
	ld.const.u32 	%r620, [%rd148];
	// inline asm
	{
	mad.lo.cc.u32   %r618, %r620, %r201, %r852;
	madc.hi.u32     %r852, %r620, %r201,  0;
	}
	// inline asm
	st.local.u32 	[%rd149], %r618;
	add.s64 	%rd149, %rd149, 4;
	add.s64 	%rd148, %rd148, 4;
	add.s32 	%r851, %r851, 1;
	setp.ne.s32	%p86, %r851, 0;
	@%p86 bra 	BB3_116;

	bfe.u32 	%r623, %r200, 23, 8;
	add.s32 	%r624, %r623, -128;
	shr.u32 	%r625, %r624, 5;
	and.b32  	%r206, %r200, -2147483648;
	st.local.u32 	[%rd2], %r852;
	bfe.u32 	%r207, %r200, 23, 5;
	mov.u32 	%r626, 6;
	sub.s32 	%r627, %r626, %r625;
	mul.wide.s32 	%rd105, %r627, 4;
	add.s64 	%rd42, %rd1, %rd105;
	ld.local.u32 	%r854, [%rd42];
	ld.local.u32 	%r853, [%rd42+-4];
	setp.eq.s32	%p87, %r207, 0;
	@%p87 bra 	BB3_119;

	mov.u32 	%r628, 32;
	sub.s32 	%r629, %r628, %r207;
	shr.u32 	%r630, %r853, %r629;
	shl.b32 	%r631, %r854, %r207;
	add.s32 	%r854, %r630, %r631;
	ld.local.u32 	%r632, [%rd42+-8];
	shr.u32 	%r633, %r632, %r629;
	shl.b32 	%r634, %r853, %r207;
	add.s32 	%r853, %r633, %r634;

BB3_119:
	shr.u32 	%r635, %r853, 30;
	shl.b32 	%r636, %r854, 2;
	add.s32 	%r856, %r636, %r635;
	shl.b32 	%r215, %r853, 2;
	shr.u32 	%r637, %r856, 31;
	shr.u32 	%r638, %r854, 30;
	add.s32 	%r216, %r637, %r638;
	setp.eq.s32	%p88, %r637, 0;
	@%p88 bra 	BB3_120;

	not.b32 	%r639, %r856;
	neg.s32 	%r855, %r215;
	setp.eq.s32	%p89, %r215, 0;
	selp.u32	%r640, 1, 0, %p89;
	add.s32 	%r856, %r640, %r639;
	xor.b32  	%r857, %r206, -2147483648;
	bra.uni 	BB3_122;
...
BB3_122:
	cvt.u64.u32	%rd106, %r856;
	cvt.u64.u32	%rd107, %r855;
	bfi.b64 	%rd108, %rd106, %rd107, 32, 32;
	cvt.rn.f64.s64	%fd23, %rd108;
	mul.f64 	%fd24, %fd23, 0d3BF921FB54442D19;
	cvt.rn.f32.f64	%f384, %fd24;
	neg.f32 	%f385, %f384;
	setp.eq.s32	%p90, %r857, 0;
	selp.f32	%f519, %f384, %f385, %p90;
	setp.eq.s32	%p91, %r206, 0;
	neg.s32 	%r641, %r216;
	selp.b32	%r858, %r216, %r641, %p91;
...
BB3_128:
	...
	shl.b32 	%r647, %r646, 2;
	add.s32 	%r649, %r345, %r647;
	st.shared.f32 	[%r649], %f402;
	add.f32 	%f403, %f107, %f401;
	add.s32 	%r651, %r347, %r647;
	st.shared.f32 	[%r651], %f403;
	sub.f32 	%f404, %f106, %f399;
	st.shared.f32 	[%r649+64], %f404;
	sub.f32 	%f405, %f107, %f401;
	st.shared.f32 	[%r651+64], %f405;
	bar.sync 	0;
	ld.shared.f32 	%f135, [%r351];
	ld.shared.f32 	%f136, [%r353];
	ld.shared.f32 	%f137, [%r351+256];
	ld.shared.f32 	%f138, [%r353+256];
	shr.u32 	%r658, %r429, 27;
	add.s32 	%r659, %r1, %r658;
	and.b32  	%r660, %r659, 2147483616;
	sub.s32 	%r661, %r1, %r660;
	shl.b32 	%r662, %r661, 1;
	cvt.rn.f32.s32	%f406, %r662;
	mul.f32 	%f407, %f406, 0f3C000000;
	cvt.f64.f32	%fd25, %f407;
	mul.f64 	%fd26, %fd25, 0dC01921FB54442D18;
	cvt.rn.f32.f64	%f139, %fd26;
	mul.f32 	%f408, %f139, 0f3F22F983;
	cvt.rni.s32.f32	%r874, %f408;
	cvt.rn.f32.s32	%f409, %r874;
...
BB3_131:
	.pragma "nounroll";
	ld.const.u32 	%r668, [%rd150];
	// inline asm
	{
	mad.lo.cc.u32   %r666, %r668, %r229, %r860;
	madc.hi.u32     %r860, %r668, %r229,  0;
	}
	// inline asm
	st.local.u32 	[%rd151], %r666;
	add.s64 	%rd151, %rd151, 4;
	add.s64 	%rd150, %rd150, 4;
	add.s32 	%r859, %r859, 1;
	setp.ne.s32	%p97, %r859, 0;
	@%p97 bra 	BB3_131;

	bfe.u32 	%r671, %r228, 23, 8;
	add.s32 	%r672, %r671, -128;
	shr.u32 	%r673, %r672, 5;
	and.b32  	%r234, %r228, -2147483648;
	st.local.u32 	[%rd2], %r860;
	bfe.u32 	%r235, %r228, 23, 5;
	mov.u32 	%r674, 6;
	sub.s32 	%r675, %r674, %r673;
	mul.wide.s32 	%rd110, %r675, 4;
	add.s64 	%rd47, %rd1, %rd110;
	ld.local.u32 	%r862, [%rd47];
	ld.local.u32 	%r861, [%rd47+-4];
	setp.eq.s32	%p98, %r235, 0;
	@%p98 bra 	BB3_134;

	mov.u32 	%r676, 32;
	sub.s32 	%r677, %r676, %r235;
	shr.u32 	%r678, %r861, %r677;
	shl.b32 	%r679, %r862, %r235;
	add.s32 	%r862, %r678, %r679;
	ld.local.u32 	%r680, [%rd47+-8];
	shr.u32 	%r681, %r680, %r677;
	shl.b32 	%r682, %r861, %r235;
	add.s32 	%r861, %r681, %r682;

BB3_134:
	shr.u32 	%r683, %r861, 30;
	shl.b32 	%r684, %r862, 2;
	add.s32 	%r864, %r684, %r683;
	shl.b32 	%r243, %r861, 2;
	shr.u32 	%r685, %r864, 31;
	shr.u32 	%r686, %r862, 30;
	add.s32 	%r244, %r685, %r686;
	setp.eq.s32	%p99, %r685, 0;
	@%p99 bra 	BB3_135;

	not.b32 	%r687, %r864;
	neg.s32 	%r863, %r243;
	setp.eq.s32	%p100, %r243, 0;
	selp.u32	%r688, 1, 0, %p100;
	add.s32 	%r864, %r688, %r687;
	xor.b32  	%r865, %r234, -2147483648;
	bra.uni 	BB3_137;
...
BB3_137:
	cvt.u64.u32	%rd111, %r864;
	cvt.u64.u32	%rd112, %r863;
	bfi.b64 	%rd113, %rd111, %rd112, 32, 32;
	cvt.rn.f64.s64	%fd27, %rd113;
	mul.f64 	%fd28, %fd27, 0d3BF921FB54442D19;
	cvt.rn.f32.f64	%f415, %fd28;
	neg.f32 	%f416, %f415;
	setp.eq.s32	%p101, %r865, 0;
	selp.f32	%f522, %f415, %f416, %p101;
	setp.eq.s32	%p102, %r234, 0;
	neg.s32 	%r689, %r244;
	selp.b32	%r866, %r244, %r689, %p102;
...
BB3_146:
	.pragma "nounroll";
	ld.const.u32 	%r696, [%rd152];
	// inline asm
	{
	mad.lo.cc.u32   %r694, %r696, %r256, %r868;
	madc.hi.u32     %r868, %r696, %r256,  0;
	}
	// inline asm
	st.local.u32 	[%rd153], %r694;
	add.s64 	%rd153, %rd153, 4;
	add.s64 	%rd152, %rd152, 4;
	add.s32 	%r867, %r867, 1;
	setp.ne.s32	%p108, %r867, 0;
	@%p108 bra 	BB3_146;

	bfe.u32 	%r699, %r255, 23, 8;
	add.s32 	%r700, %r699, -128;
	shr.u32 	%r701, %r700, 5;
	and.b32  	%r261, %r255, -2147483648;
	st.local.u32 	[%rd2], %r868;
	bfe.u32 	%r262, %r255, 23, 5;
	mov.u32 	%r702, 6;
	sub.s32 	%r703, %r702, %r701;
	mul.wide.s32 	%rd115, %r703, 4;
	add.s64 	%rd52, %rd1, %rd115;
	ld.local.u32 	%r870, [%rd52];
	ld.local.u32 	%r869, [%rd52+-4];
	setp.eq.s32	%p109, %r262, 0;
	@%p109 bra 	BB3_149;

	mov.u32 	%r704, 32;
	sub.s32 	%r705, %r704, %r262;
	shr.u32 	%r706, %r869, %r705;
	shl.b32 	%r707, %r870, %r262;
	add.s32 	%r870, %r706, %r707;
	ld.local.u32 	%r708, [%rd52+-8];
	shr.u32 	%r709, %r708, %r705;
	shl.b32 	%r710, %r869, %r262;
	add.s32 	%r869, %r709, %r710;

BB3_149:
	shr.u32 	%r711, %r869, 30;
	shl.b32 	%r712, %r870, 2;
	add.s32 	%r872, %r712, %r711;
	shl.b32 	%r270, %r869, 2;
	shr.u32 	%r713, %r872, 31;
	shr.u32 	%r714, %r870, 30;
	add.s32 	%r271, %r713, %r714;
	setp.eq.s32	%p110, %r713, 0;
	@%p110 bra 	BB3_150;

	not.b32 	%r715, %r872;
	neg.s32 	%r871, %r270;
	setp.eq.s32	%p111, %r270, 0;
	selp.u32	%r716, 1, 0, %p111;
	add.s32 	%r872, %r716, %r715;
	xor.b32  	%r873, %r261, -2147483648;
	bra.uni 	BB3_152;
...
BB3_152:
	cvt.u64.u32	%rd116, %r872;
	cvt.u64.u32	%rd117, %r871;
	bfi.b64 	%rd118, %rd116, %rd117, 32, 32;
	cvt.rn.f64.s64	%fd29, %rd118;
	mul.f64 	%fd30, %fd29, 0d3BF921FB54442D19;
	cvt.rn.f32.f64	%f428, %fd30;
	neg.f32 	%f429, %f428;
	setp.eq.s32	%p112, %r873, 0;
	selp.f32	%f525, %f428, %f429, %p112;
	setp.eq.s32	%p113, %r261, 0;
	neg.s32 	%r717, %r271;
	selp.b32	%r874, %r271, %r717, %p113;
...
BB3_158:
	...
	shl.b32 	%r723, %r722, 2;
	add.s32 	%r725, %r420, %r723;
	st.shared.f32 	[%r725], %f446;
	add.f32 	%f447, %f136, %f445;
	add.s32 	%r727, %r422, %r723;
	st.shared.f32 	[%r727], %f447;
	sub.f32 	%f448, %f135, %f443;
	st.shared.f32 	[%r725+128], %f448;
	sub.f32 	%f449, %f136, %f445;
	st.shared.f32 	[%r727+128], %f449;
	bar.sync 	0;
	ld.shared.f32 	%f164, [%r426];
	ld.shared.f32 	%f165, [%r428];
	ld.shared.f32 	%f166, [%r426+256];
	ld.shared.f32 	%f167, [%r428+256];
	add.s32 	%r281, %r2, %r1;
	shr.u32 	%r735, %r429, 26;
	...
	cvt.rni.s32.f32	%r890, %f452;
	cvt.rn.f32.s32	%f453, %r890;
...
BB3_161:
	.pragma "nounroll";
	ld.const.u32 	%r744, [%rd154];
	// inline asm
	{
	mad.lo.cc.u32   %r742, %r744, %r284, %r876;
	madc.hi.u32     %r876, %r744, %r284,  0;
	}
	// inline asm
	st.local.u32 	[%rd155], %r742;
	add.s64 	%rd155, %rd155, 4;
	add.s64 	%rd154, %rd154, 4;
	add.s32 	%r875, %r875, 1;
	setp.ne.s32	%p119, %r875, 0;
	@%p119 bra 	BB3_161;

	bfe.u32 	%r747, %r283, 23, 8;
	add.s32 	%r748, %r747, -128;
	shr.u32 	%r749, %r748, 5;
	and.b32  	%r289, %r283, -2147483648;
	st.local.u32 	[%rd2], %r876;
	bfe.u32 	%r290, %r283, 23, 5;
	mov.u32 	%r750, 6;
	sub.s32 	%r751, %r750, %r749;
	mul.wide.s32 	%rd120, %r751, 4;
	add.s64 	%rd57, %rd1, %rd120;
	ld.local.u32 	%r878, [%rd57];
	ld.local.u32 	%r877, [%rd57+-4];
	setp.eq.s32	%p120, %r290, 0;
	@%p120 bra 	BB3_164;

	mov.u32 	%r752, 32;
	sub.s32 	%r753, %r752, %r290;
	shr.u32 	%r754, %r877, %r753;
	shl.b32 	%r755, %r878, %r290;
	add.s32 	%r878, %r754, %r755;
	ld.local.u32 	%r756, [%rd57+-8];
	shr.u32 	%r757, %r756, %r753;
	shl.b32 	%r758, %r877, %r290;
	add.s32 	%r877, %r757, %r758;

BB3_164:
	shr.u32 	%r759, %r877, 30;
	shl.b32 	%r760, %r878, 2;
	add.s32 	%r880, %r760, %r759;
	shl.b32 	%r298, %r877, 2;
	shr.u32 	%r761, %r880, 31;
	shr.u32 	%r762, %r878, 30;
	add.s32 	%r299, %r761, %r762;
	setp.eq.s32	%p121, %r761, 0;
	@%p121 bra 	BB3_165;

	not.b32 	%r763, %r880;
	neg.s32 	%r879, %r298;
	setp.eq.s32	%p122, %r298, 0;
	selp.u32	%r764, 1, 0, %p122;
	add.s32 	%r880, %r764, %r763;
	xor.b32  	%r881, %r289, -2147483648;
	bra.uni 	BB3_167;
...
BB3_167:
	cvt.u64.u32	%rd121, %r880;
	cvt.u64.u32	%rd122, %r879;
	bfi.b64 	%rd123, %rd121, %rd122, 32, 32;
	cvt.rn.f64.s64	%fd33, %rd123;
	mul.f64 	%fd34, %fd33, 0d3BF921FB54442D19;
	cvt.rn.f32.f64	%f459, %fd34;
	neg.f32 	%f460, %f459;
	setp.eq.s32	%p123, %r881, 0;
	selp.f32	%f528, %f459, %f460, %p123;
	setp.eq.s32	%p124, %r289, 0;
	neg.s32 	%r765, %r299;
	selp.b32	%r882, %r299, %r765, %p124;
...
BB3_176:
	.pragma "nounroll";
	ld.const.u32 	%r772, [%rd156];
	// inline asm
	{
	mad.lo.cc.u32   %r770, %r772, %r311, %r884;
	madc.hi.u32     %r884, %r772, %r311,  0;
	}
	// inline asm
	st.local.u32 	[%rd157], %r770;
	add.s64 	%rd157, %rd157, 4;
	add.s64 	%rd156, %rd156, 4;
	add.s32 	%r883, %r883, 1;
	setp.ne.s32	%p130, %r883, 0;
	@%p130 bra 	BB3_176;

	bfe.u32 	%r775, %r310, 23, 8;
	add.s32 	%r776, %r775, -128;
	shr.u32 	%r777, %r776, 5;
	and.b32  	%r316, %r310, -2147483648;
	st.local.u32 	[%rd2], %r884;
	bfe.u32 	%r317, %r310, 23, 5;
	mov.u32 	%r778, 6;
	sub.s32 	%r779, %r778, %r777;
	mul.wide.s32 	%rd125, %r779, 4;
	add.s64 	%rd62, %rd1, %rd125;
	ld.local.u32 	%r886, [%rd62];
	ld.local.u32 	%r885, [%rd62+-4];
	setp.eq.s32	%p131, %r317, 0;
	@%p131 bra 	BB3_179;

	mov.u32 	%r780, 32;
	sub.s32 	%r781, %r780, %r317;
	shr.u32 	%r782, %r885, %r781;
	shl.b32 	%r783, %r886, %r317;
	add.s32 	%r886, %r782, %r783;
	ld.local.u32 	%r784, [%rd62+-8];
	shr.u32 	%r785, %r784, %r781;
	shl.b32 	%r786, %r885, %r317;
	add.s32 	%r885, %r785, %r786;

BB3_179:
	shr.u32 	%r787, %r885, 30;
	shl.b32 	%r788, %r886, 2;
	add.s32 	%r888, %r788, %r787;
	shl.b32 	%r325, %r885, 2;
	shr.u32 	%r789, %r888, 31;
	shr.u32 	%r790, %r886, 30;
	add.s32 	%r326, %r789, %r790;
	...
	add.s32 	%r888, %r792, %r791;
	xor.b32  	%r889, %r316, -2147483648;
	bra.uni 	BB3_182;
...
BB3_182:
	cvt.u64.u32	%rd126, %r888;
	cvt.u64.u32	%rd127, %r887;
	bfi.b64 	%rd128, %rd126, %rd127, 32, 32;
	cvt.rn.f64.s64	%fd35, %rd128;
	mul.f64 	%fd36, %fd35, 0d3BF921FB54442D19;
	cvt.rn.f32.f64	%f472, %fd36;
	neg.f32 	%f473, %f472;
	setp.eq.s32	%p134, %r889, 0;
	selp.f32	%f531, %f472, %f473, %p134;
	setp.eq.s32	%p135, %r316, 0;
	neg.s32 	%r793, %r326;
	selp.b32	%r890, %r326, %r793, %p135;

BB3_184:
	and.b32  	%r335, %r890, 1;
	setp.eq.s32	%p136, %r335, 0;
...
BB3_188:
	...
	mul.wide.u32 	%rd130, %r281, 4;
	add.s64 	%rd131, %rd65, %rd130;
	st.global.f32 	[%rd131], %f490;
	add.f32 	%f491, %f165, %f489;
	cvta.to.global.u64 	%rd132, %rd64;
	add.s64 	%rd133, %rd132, %rd130;
	st.global.f32 	[%rd133], %f491;
	sub.f32 	%f492, %f164, %f487;
	st.global.f32 	[%rd131+256], %f492;
	sub.f32 	%f493, %f165, %f489;
	st.global.f32 	[%rd133+256], %f493;
	ret;
}
...
.maxntid 64, 1, 1
{
	...
	ld.param.u64 	%rd7, [_occa_Window_Hanning_0_param_0];
	ld.param.u32 	%r30, [_occa_Window_Hanning_0_param_2];
	mov.u32 	%r31, %ctaid.x;
	shl.b32 	%r32, %r31, 6;
	mov.u32 	%r33, %tid.x;
	add.s32 	%r1, %r32, %r33;
...
BB13_3:
	.pragma "nounroll";
	ld.const.u32 	%r41, [%rd17];
	// inline asm
	{
	mad.lo.cc.u32   %r39, %r41, %r4, %r65;
	madc.hi.u32     %r65, %r41, %r4,  0;
	}
	// inline asm
	st.local.u32 	[%rd18], %r39;
	add.s64 	%rd18, %rd18, 4;
	add.s64 	%rd17, %rd17, 4;
	add.s32 	%r64, %r64, 1;
	...
	st.local.u32 	[%rd1+24], %r65;
	bfe.u32 	%r10, %r3, 23, 5;
	mov.u32 	%r47, 6;
	sub.s32 	%r48, %r47, %r46;
	mul.wide.s32 	%rd10, %r48, 4;
	add.s64 	%rd6, %rd1, %rd10;
	ld.local.u32 	%r67, [%rd6];
	ld.local.u32 	%r66, [%rd6+-4];
...
.maxntid 64, 1, 1
{
	...
	ld.param.u64 	%rd7, [_occa_Window_Hamming_0_param_0];
	ld.param.u32 	%r30, [_occa_Window_Hamming_0_param_2];
	mov.u32 	%r31, %ctaid.x;
	shl.b32 	%r32, %r31, 6;
	mov.u32 	%r33, %tid.x;
	add.s32 	%r1, %r32, %r33;
...
.maxntid 64, 1, 1
{
	...
	ld.param.u32 	%r58, [_occa_Window_Blackman_0_param_2];
	mov.u32 	%r59, %ctaid.x;
	shl.b32 	%r60, %r59, 6;
	mov.u32 	%r61, %tid.x;
	add.s32 	%r1, %r60, %r61;
	...
	cvt.rni.s32.f32	%r127, %f30;
	cvt.rn.f32.s32	%f31, %r127;
...
BB15_3:
	.pragma "nounroll";
	ld.const.u32 	%r69, [%rd28];
	// inline asm
	{
	mad.lo.cc.u32   %r67, %r69, %r4, %r121;
	madc.hi.u32     %r121, %r69, %r4,  0;
	}
	// inline asm
	st.local.u32 	[%rd29], %r67;
	add.s64 	%rd29, %rd29, 4;
	add.s64 	%rd28, %rd28, 4;
	add.s32 	%r120, %r120, 1;
	setp.ne.s32	%p3, %r120, 0;
	@%p3 bra 	BB15_3;
	...
	ld.local.u32 	%r123, [%rd7];
	ld.local.u32 	%r122, [%rd7+-4];
	setp.eq.s32	%p4, %r10, 0;
	@%p4 bra 	BB15_6;

	mov.u32 	%r77, 32;
	sub.s32 	%r78, %r77, %r10;
	shr.u32 	%r79, %r122, %r78;
	shl.b32 	%r80, %r123, %r10;
	add.s32 	%r123, %r79, %r80;
	ld.local.u32 	%r81, [%rd7+-8];
	shr.u32 	%r82, %r81, %r78;
	shl.b32 	%r83, %r122, %r10;
	add.s32 	%r122, %r82, %r83;

BB15_6:
	shr.u32 	%r84, %r122, 30;
	shl.b32 	%r85, %r123, 2;
	add.s32 	%r125, %r85, %r84;
	shl.b32 	%r18, %r122, 2;
	shr.u32 	%r86, %r125, 31;
	shr.u32 	%r87, %r123, 30;
	add.s32 	%r19, %r86, %r87;
	...
	setp.eq.s32	%p6, %r18, 0;
	selp.u32	%r89, 1, 0, %p6;
	add.s32 	%r125, %r89, %r88;
	xor.b32  	%r126, %r9, -2147483648;
	bra.uni 	BB15_9;
...
BB15_15:
	...
	cvt.rni.s32.f32	%r135, %f50;
	cvt.rn.f32.s32	%f51, %r135;
...
BB15_18:
	.pragma "nounroll";
	ld.const.u32 	%r97, [%rd30];
	// inline asm
	{
	mad.lo.cc.u32   %r95, %r97, %r32, %r129;
	madc.hi.u32     %r129, %r97, %r32,  0;
	}
	// inline asm
	st.local.u32 	[%rd31], %r95;
	add.s64 	%rd31, %rd31, 4;
	add.s64 	%rd30, %rd30, 4;
	add.s32 	%r128, %r128, 1;
	...
	ld.local.u32 	%r131, [%rd12];
	ld.local.u32 	%r130, [%rd12+-4];
	setp.eq.s32	%p15, %r38, 0;
	@%p15 bra 	BB15_21;

	mov.u32 	%r105, 32;
	sub.s32 	%r106, %r105, %r38;
	shr.u32 	%r107, %r130, %r106;
	shl.b32 	%r108, %r131, %r38;
	add.s32 	%r131, %r107, %r108;
	ld.local.u32 	%r109, [%rd12+-8];
	shr.u32 	%r110, %r109, %r106;
	shl.b32 	%r111, %r130, %r38;
	add.s32 	%r130, %r110, %r111;

BB15_21:
	shr.u32 	%r112, %r130, 30;
	shl.b32 	%r113, %r131, 2;
	add.s32 	%r133, %r113, %r112;
	shl.b32 	%r46, %r130, 2;
	shr.u32 	%r114, %r133, 31;
	shr.u32 	%r115, %r131, 30;
	add.s32 	%r47, %r114, %r115;
	...
	add.s32 	%r133, %r117, %r116;
	xor.b32  	%r134, %r37, -2147483648;
	bra.uni 	BB15_24;
...
BB15_24:
	cvt.u64.u32	%rd22, %r133;
	cvt.u64.u32	%rd23, %r132;
	bfi.b64 	%rd24, %rd22, %rd23, 32, 32;
	cvt.rn.f64.s64	%fd7, %rd24;
	mul.f64 	%fd8, %fd7, 0d3BF921FB54442D19;
...
.maxntid 64, 1, 1
{
	...
	ld.param.u64 	%rd18, [_occa_Window_Nuttall_0_param_0];
	ld.param.u32 	%r86, [_occa_Window_Nuttall_0_param_2];
	mov.u32 	%r87, %ctaid.x;
	shl.b32 	%r88, %r87, 6;
	mov.u32 	%r89, %tid.x;
	add.s32 	%r1, %r88, %r89;
	...
	cvt.rni.s32.f32	%r183, %f44;
	cvt.rn.f32.s32	%f45, %r183;
...
BB16_3:
	.pragma "nounroll";
	ld.const.u32 	%r97, [%rd38];
	// inline asm
	{
	mad.lo.cc.u32   %r95, %r97, %r4, %r177;
	madc.hi.u32     %r177, %r97, %r4,  0;
	}
	// inline asm
	st.local.u32 	[%rd39], %r95;
	add.s64 	%rd39, %rd39, 4;
	add.s64 	%rd38, %rd38, 4;
	add.s32 	%r176, %r176, 1;
	setp.ne.s32	%p3, %r176, 0;
	@%p3 bra 	BB16_3;
	...
	shl.b32 	%r108, %r179, %r10;
	add.s32 	%r179, %r107, %r108;
	ld.local.u32 	%r109, [%rd7+-8];
	shr.u32 	%r110, %r109, %r106;
	shl.b32 	%r111, %r178, %r10;
	add.s32 	%r178, %r110, %r111;

BB16_6:
	shr.u32 	%r112, %r178, 30;
	shl.b32 	%r113, %r179, 2;
	add.s32 	%r181, %r113, %r112;
	shl.b32 	%r18, %r178, 2;
	shr.u32 	%r114, %r181, 31;
	shr.u32 	%r115, %r179, 30;
	add.s32 	%r19, %r114, %r115;
...
BB16_9:
	cvt.u64.u32	%rd22, %r181;
	cvt.u64.u32	%rd23, %r180;
	bfi.b64 	%rd24, %rd22, %rd23, 32, 32;
	cvt.rn.f64.s64	%fd6, %rd24;
...
BB16_15:
	...
	cvt.rni.s32.f32	%r191, %f64;
	cvt.rn.f32.s32	%f65, %r191;
...
BB16_18:
	.pragma "nounroll";
	ld.const.u32 	%r125, [%rd40];
	// inline asm
	{
	mad.lo.cc.u32   %r123, %r125, %r32, %r185;
	madc.hi.u32     %r185, %r125, %r32,  0;
	}
	// inline asm
	st.local.u32 	[%rd41], %r123;
	add.s64 	%rd41, %rd41, 4;
	add.s64 	%rd40, %rd40, 4;
	add.s32 	%r184, %r184, 1;
	setp.ne.s32	%p14, %r184, 0;
	@%p14 bra 	BB16_18;

	bfe.u32 	%r128, %r31, 23, 8;
	...
	ld.local.u32 	%r186, [%rd12+-4];
	setp.eq.s32	%p15, %r38, 0;
	@%p15 bra 	BB16_21;

	mov.u32 	%r133, 32;
	sub.s32 	%r134, %r133, %r38;
	shr.u32 	%r135, %r186, %r134;
	shl.b32 	%r136, %r187, %r38;
	add.s32 	%r187, %r135, %r136;
	ld.local.u32 	%r137, [%rd12+-8];
	shr.u32 	%r138, %r137, %r134;
	shl.b32 	%r139, %r186, %r38;
	add.s32 	%r186, %r138, %r139;

BB16_21:
	shr.u32 	%r140, %r186, 30;
	shl.b32 	%r141, %r187, 2;
	add.s32 	%r189, %r141, %r140;
	shl.b32 	%r46, %r186, 2;
	shr.u32 	%r142, %r189, 31;
	shr.u32 	%r143, %r187, 30;
	add.s32 	%r47, %r142, %r143;
...
BB16_24:
	cvt.u64.u32	%rd27, %r189;
	cvt.u64.u32	%rd28, %r188;
	bfi.b64 	%rd29, %rd27, %rd28, 32, 32;
	cvt.rn.f64.s64	%fd8, %rd29;
...
BB16_30:
	...
	cvt.rni.s32.f32	%r199, %f84;
	cvt.rn.f32.s32	%f85, %r199;
...
BB16_33:
	.pragma "nounroll";
	ld.const.u32 	%r153, [%rd42];
	// inline asm
	{
	mad.lo.cc.u32   %r151, %r153, %r60, %r193;
	madc.hi.u32     %r193, %r153, %r60,  0;
	}
	// inline asm
	st.local.u32 	[%rd43], %r151;
	add.s64 	%rd43, %rd43, 4;
	add.s64 	%rd42, %rd42, 4;
	add.s32 	%r192, %r192, 1;
	setp.ne.s32	%p25, %r192, 0;
	@%p25 bra 	BB16_33;

	bfe.u32 	%r156, %r59, 23, 8;
	add.s32 	%r157, %r156, -128;
	shr.u32 	%r158, %r157, 5;
	and.b32  	%r65, %r59, -2147483648;
	st.local.u32 	[%rd2], %r193;
	bfe.u32 	%r66, %r59, 23, 5;
	mov.u32 	%r159, 6;
	sub.s32 	%r160, %r159, %r158;
	mul.wide.s32 	%rd31, %r160, 4;
	add.s64 	%rd17, %rd1, %rd31;
	ld.local.u32 	%r195, [%rd17];
	ld.local.u32 	%r194, [%rd17+-4];
	setp.eq.s32	%p26, %r66, 0;
	@%p26 bra 	BB16_36;

	mov.u32 	%r161, 32;
	sub.s32 	%r162, %r161, %r66;
	shr.u32 	%r163, %r194, %r162;
	shl.b32 	%r164, %r195, %r66;
	add.s32 	%r195, %r163, %r164;
	ld.local.u32 	%r165, [%rd17+-8];
	shr.u32 	%r166, %r165, %r162;
	shl.b32 	%r167, %r194, %r66;
	add.s32 	%r194, %r166, %r167;

BB16_36:
	shr.u32 	%r168, %r194, 30;
	shl.b32 	%r169, %r195, 2;
	add.s32 	%r197, %r169, %r168;
	shl.b32 	%r74, %r194, 2;
	shr.u32 	%r170, %r197, 31;
	shr.u32 	%r171, %r195, 30;
	add.s32 	%r75, %r170, %r171;
	...
	add.s32 	%r197, %r173, %r172;
	xor.b32  	%r198, %r65, -2147483648;
	bra.uni 	BB16_39;
...
.maxntid 64, 1, 1
{
	...
	ld.param.u64 	%rd18, [_occa_Window_Blackman_Nuttall_0_param_0];
	ld.param.u32 	%r86, [_occa_Window_Blackman_Nuttall_0_param_2];
	mov.u32 	%r87, %ctaid.x;
	shl.b32 	%r88, %r87, 6;
	mov.u32 	%r89, %tid.x;
	add.s32 	%r1, %r88, %r89;
...
.maxntid 64, 1, 1
{
	...
	ld.param.u64 	%rd18, [_occa_Window_Blackman_harris_0_param_0];
	ld.param.u32 	%r86, [_occa_Window_Blackman_harris_0_param_2];
	mov.u32 	%r87, %ctaid.x;
	shl.b32 	%r88, %r87, 6;
	mov.u32 	%r89, %tid.x;
	add.s32 	%r1, %r88, %r89;
...
.maxntid 64, 1, 1
{
	...
	ld.param.u64 	%rd23, [_occa_Window_FlatTop_0_param_0];
	ld.param.u32 	%r114, [_occa_Window_FlatTop_0_param_2];
	mov.u32 	%r115, %ctaid.x;
	shl.b32 	%r116, %r115, 6;
	mov.u32 	%r117, %tid.x;
	add.s32 	%r1, %r116, %r117;
	add.s32 	%r118, %r114, -1;
	and.b32  	%r119, %r1, %r118;
	cvt.rn.f64.s32	%fd3, %r119;
	mul.f64 	%fd4, %fd3, 0d401921FB54442D18;
	cvt.rn.f32.s32	%f57, %r114;
	cvt.f64.f32	%fd5, %f57;
	...
	cvt.rni.s32.f32	%r239, %f58;
	cvt.rn.f32.s32	%f59, %r239;
...
BB19_3:
	.pragma "nounroll";
	ld.const.u32 	%r125, [%rd48];
	// inline asm
	{
	mad.lo.cc.u32   %r123, %r125, %r4, %r233;
	madc.hi.u32     %r233, %r125, %r4,  0;
	}
	// inline asm
	st.local.u32 	[%rd49], %r123;
	add.s64 	%rd49, %rd49, 4;
	add.s64 	%rd48, %rd48, 4;
	add.s32 	%r232, %r232, 1;
	setp.ne.s32	%p3, %r232, 0;
	@%p3 bra 	BB19_3;

	bfe.u32 	%r128, %r3, 23, 8;
	add.s32 	%r129, %r128, -128;
	shr.u32 	%r130, %r129, 5;
	and.b32  	%r9, %r3, -2147483648;
	...
	mul.wide.s32 	%rd26, %r132, 4;
	add.s64 	%rd7, %rd1, %rd26;
	ld.local.u32 	%r235, [%rd7];
	ld.local.u32 	%r234, [%rd7+-4];
	setp.eq.s32	%p4, %r10, 0;
	@%p4 bra 	BB19_6;

	mov.u32 	%r133, 32;
	sub.s32 	%r134, %r133, %r10;
	shr.u32 	%r135, %r234, %r134;
	shl.b32 	%r136, %r235, %r10;
	add.s32 	%r235, %r135, %r136;
	ld.local.u32 	%r137, [%rd7+-8];
	shr.u32 	%r138, %r137, %r134;
	shl.b32 	%r139, %r234, %r10;
	add.s32 	%r234, %r138, %r139;

BB19_6:
	shr.u32 	%r140, %r234, 30;
	shl.b32 	%r141, %r235, 2;
	add.s32 	%r237, %r141, %r140;
	shl.b32 	%r18, %r234, 2;
	shr.u32 	%r142, %r237, 31;
	shr.u32 	%r143, %r235, 30;
	add.s32 	%r19, %r142, %r143;
...
BB19_9:
	cvt.u64.u32	%rd27, %r237;
	cvt.u64.u32	%rd28, %r236;
	bfi.b64 	%rd29, %rd27, %rd28, 32, 32;
	cvt.rn.f64.s64	%fd7, %rd29;
	mul.f64 	%fd8, %fd7, 0d3BF921FB54442D19;
	cvt.rn.f32.f64	%f65, %fd8;
	neg.f32 	%f66, %f65;
	setp.eq.s32	%p7, %r238, 0;
	selp.f32	%f141, %f65, %f66, %p7;
	setp.eq.s32	%p8, %r9, 0;
	neg.s32 	%r146, %r19;
	selp.b32	%r239, %r19, %r146, %p8;
...
BB19_15:
	...
	cvt.rni.s32.f32	%r247, %f78;
	cvt.rn.f32.s32	%f79, %r247;
...
BB19_18:
	...
	// inline asm
	{
	mad.lo.cc.u32   %r151, %r153, %r32, %r241;
	madc.hi.u32     %r241, %r153, %r32,  0;
	}
	// inline asm
	...
	bfe.u32 	%r156, %r31, 23, 8;
	add.s32 	%r157, %r156, -128;
	shr.u32 	%r158, %r157, 5;
	and.b32  	%r37, %r31, -2147483648;
	st.local.u32 	[%rd2], %r241;
	bfe.u32 	%r38, %r31, 23, 5;
	mov.u32 	%r159, 6;
	sub.s32 	%r160, %r159, %r158;
	mul.wide.s32 	%rd31, %r160, 4;
	add.s64 	%rd12, %rd1, %rd31;
	ld.local.u32 	%r243, [%rd12];
	ld.local.u32 	%r242, [%rd12+-4];
	setp.eq.s32	%p15, %r38, 0;
	@%p15 bra 	BB19_21;

	mov.u32 	%r161, 32;
	sub.s32 	%r162, %r161, %r38;
	shr.u32 	%r163, %r242, %r162;
	shl.b32 	%r164, %r243, %r38;
	add.s32 	%r243, %r163, %r164;
	ld.local.u32 	%r165, [%rd12+-8];
	shr.u32 	%r166, %r165, %r162;
	shl.b32 	%r167, %r242, %r38;
	add.s32 	%r242, %r166, %r167;

BB19_21:
	shr.u32 	%r168, %r242, 30;
	shl.b32 	%r169, %r243, 2;
	add.s32 	%r245, %r169, %r168;
	shl.b32 	%r46, %r242, 2;
	shr.u32 	%r170, %r245, 31;
	shr.u32 	%r171, %r243, 30;
	add.s32 	%r47, %r170, %r171;
	...
	add.s32 	%r245, %r173, %r172;
	xor.b32  	%r246, %r37, -2147483648;
	bra.uni 	BB19_24;
...
BB19_24:
	cvt.u64.u32	%rd32, %r245;
	cvt.u64.u32	%rd33, %r244;
	bfi.b64 	%rd34, %rd32, %rd33, 32, 32;
	cvt.rn.f64.s64	%fd9, %rd34;
	mul.f64 	%fd10, %fd9, 0d3BF921FB54442D19;
	cvt.rn.f32.f64	%f85, %fd10;
	neg.f32 	%f86, %f85;
	setp.eq.s32	%p18, %r246, 0;
	selp.f32	%f144, %f85, %f86, %p18;
	setp.eq.s32	%p19, %r37, 0;
	neg.s32 	%r174, %r47;
	selp.b32	%r247, %r47, %r174, %p19;
...
BB19_30:
	...
	cvt.rni.s32.f32	%r255, %f98;
	cvt.rn.f32.s32	%f99, %r255;
...
BB19_33:
	.pragma "nounroll";
	ld.const.u32 	%r181, [%rd52];
	// inline asm
	{
	mad.lo.cc.u32   %r179, %r181, %r60, %r249;
	madc.hi.u32     %r249, %r181, %r60,  0;
	}
	// inline asm
	st.local.u32 	[%rd53], %r179;
	add.s64 	%rd53, %rd53, 4;
	add.s64 	%rd52, %rd52, 4;
	add.s32 	%r248, %r248, 1;
	setp.ne.s32	%p25, %r248, 0;
	@%p25 bra 	BB19_33;

	bfe.u32 	%r184, %r59, 23, 8;
	add.s32 	%r185, %r184, -128;
	shr.u32 	%r186, %r185, 5;
	and.b32  	%r65, %r59, -2147483648;
	st.local.u32 	[%rd2], %r249;
	bfe.u32 	%r66, %r59, 23, 5;
	mov.u32 	%r187, 6;
	sub.s32 	%r188, %r187, %r186;
	mul.wide.s32 	%rd36, %r188, 4;
	add.s64 	%rd17, %rd1, %rd36;
	ld.local.u32 	%r251, [%rd17];
	ld.local.u32 	%r250, [%rd17+-4];
	setp.eq.s32	%p26, %r66, 0;
	@%p26 bra 	BB19_36;

	mov.u32 	%r189, 32;
	sub.s32 	%r190, %r189, %r66;
	shr.u32 	%r191, %r250, %r190;
	shl.b32 	%r192, %r251, %r66;
	add.s32 	%r251, %r191, %r192;
	ld.local.u32 	%r193, [%rd17+-8];
	shr.u32 	%r194, %r193, %r190;
	shl.b32 	%r195, %r250, %r66;
	add.s32 	%r250, %r194, %r195;

BB19_36:
	shr.u32 	%r196, %r250, 30;
	shl.b32 	%r197, %r251, 2;
	add.s32 	%r253, %r197, %r196;
	shl.b32 	%r74, %r250, 2;
	shr.u32 	%r198, %r253, 31;
	shr.u32 	%r199, %r251, 30;
	add.s32 	%r75, %r198, %r199;
	...
	add.s32 	%r253, %r201, %r200;
	xor.b32  	%r254, %r65, -2147483648;
	bra.uni 	BB19_39;
...
BB19_45:
	...
	cvt.rni.s32.f32	%r263, %f118;
	cvt.rn.f32.s32	%f119, %r263;
...
BB19_48:
	.pragma "nounroll";
	ld.const.u32 	%r209, [%rd54];
	// inline asm
	{
	mad.lo.cc.u32   %r207, %r209, %r88, %r257;
	madc.hi.u32     %r257, %r209, %r88,  0;
	}
	// inline asm
	st.local.u32 	[%rd55], %r207;
	add.s64 	%rd55, %rd55, 4;
	add.s64 	%rd54, %rd54, 4;
	add.s32 	%r256, %r256, 1;
	setp.ne.s32	%p36, %r256, 0;
	@%p36 bra 	BB19_48;

	bfe.u32 	%r212, %r87, 23, 8;
	add.s32 	%r213, %r212, -128;
	shr.u32 	%r214, %r213, 5;
	and.b32  	%r93, %r87, -2147483648;
	st.local.u32 	[%rd2], %r257;
	bfe.u32 	%r94, %r87, 23, 5;
	mov.u32 	%r215, 6;
	sub.s32 	%r216, %r215, %r214;
	mul.wide.s32 	%rd41, %r216, 4;
	add.s64 	%rd22, %rd1, %rd41;
	ld.local.u32 	%r259, [%rd22];
	ld.local.u32 	%r258, [%rd22+-4];
	setp.eq.s32	%p37, %r94, 0;
	@%p37 bra 	BB19_51;

	mov.u32 	%r217, 32;
	sub.s32 	%r218, %r217, %r94;
	shr.u32 	%r219, %r258, %r218;
	shl.b32 	%r220, %r259, %r94;
	add.s32 	%r259, %r219, %r220;
	ld.local.u32 	%r221, [%rd22+-8];
	shr.u32 	%r222, %r221, %r218;
	shl.b32 	%r223, %r258, %r94;
	add.s32 	%r258, %r222, %r223;

BB19_51:
	shr.u32 	%r224, %r258, 30;
	shl.b32 	%r225, %r259, 2;
	add.s32 	%r261, %r225, %r224;
	shl.b32 	%r102, %r258, 2;
	shr.u32 	%r226, %r261, 31;
	shr.u32 	%r227, %r259, 30;
	add.s32 	%r103, %r226, %r227;
	...
	add.s32 	%r261, %r229, %r228;
	xor.b32  	%r262, %r93, -2147483648;
	bra.uni 	BB19_54;
...
BB19_54:
	cvt.u64.u32	%rd42, %r261;
	cvt.u64.u32	%rd43, %r260;
	bfi.b64 	%rd44, %rd42, %rd43, 32, 32;
	cvt.rn.f64.s64	%fd17, %rd44;
	mul.f64 	%fd18, %fd17, 0d3BF921FB54442D19;
	...
	neg.s32 	%r230, %r103;
	selp.b32	%r263, %r103, %r230, %p41;

BB19_56:
	add.s32 	%r112, %r263, 1;
	and.b32  	%r113, %r112, 1;
	setp.eq.s32	%p42, %r113, 0;
...
BB19_60:
	...
	ld.global.f32 	%f139, [%rd47];
	mul.f32 	%f140, %f139, %f138;
	st.global.f32 	[%rd47], %f140;
	ret;
}
