...
Compilation options: -lang cpp -light -it -nvi -ct 1 -mapp -cn CompressorFAUSTMan -scn CompressorMan -es 1 -exp10 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0 -vec -lv 0 -vs 32
------------------------------------------------------------ */
...
class CompressorFAUSTMan final : public CompressorMan {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-lang cpp -light -it -nvi -ct 1 -mapp -cn CompressorFAUSTMan -scn CompressorMan -es 1 -exp10 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0 -vec -lv 0 -vs 32");
