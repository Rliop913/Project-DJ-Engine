...
#ifndef PDJE_EXPECTED_ONNXRUNTIME_VERSION
#define PDJE_EXPECTED_ONNXRUNTIME_VERSION ""
#endif

namespace {

constexpr std::string_view kExpectedOrtVersion = PDJE_EXPECTED_ONNXRUNTIME_VERSION;
