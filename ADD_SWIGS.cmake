...
target_link_libraries(${SWIG_MODULE_pdje_python_REAL_NAME} PRIVATE nlohmann_json::nlohmann_json Python::Python ${install_dir}/lib/libgit2.a)

target_link_libraries(${SWIG_MODULE_pdje_python_REAL_NAME} PRIVATE nlohmann_json::nlohmann_json hwy ${install_dir}/lib/libgit2.a)
target_link_libraries(${SWIG_MODULE_pdje_csharp_REAL_NAME} PRIVATE nlohmann_json::nlohmann_json hwy ${install_dir}/lib/libgit2.a)
